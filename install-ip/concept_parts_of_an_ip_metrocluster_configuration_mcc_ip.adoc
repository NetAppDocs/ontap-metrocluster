---
permalink: install-ip/concept_parts_of_an_ip_metrocluster_configuration_mcc_ip.html
sidebar: sidebar
keywords: 
summary: ''
---
...
link:task_installing_and_cabling_the_metrocluster_components.md#[Cabling the cluster peering connections]
