...
= Port tables for MetroCluster IP configurations
:icons: font
:imagesdir: ../media/

[.lead]
You must understand how to use the information in the port tables to correctly generate your reference configuration files (RCFs).
