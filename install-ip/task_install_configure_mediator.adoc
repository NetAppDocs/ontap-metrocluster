...
1.3
a|
Red Hat Enterprise Linux or CentOS 7.6, 7.7, 7.8, 7.9, 8.0, 8.1, 8.2, 8.3

a|
1.2
a|
Red Hat Enterprise Linux or CentOS 7.6, 7.7, 7.8, 8.0, 8.1
|===
 ...
 ** 31784
 ** 3260
* If using a third-party firewall: refer to link:concept_configure_the_ontap_mediator_for_unplanned_automatic_switchover.html#firewall-requirements-for-ontap-mediator[Firewall requirements for ONTAP Mediator]
...
link:concept_configure_the_ontap_mediator_for_unplanned_automatic_switchover.html#guidelines-for-upgrading-the-ontap-mediator-in-a-metrocluster-configuration[Guidelines for upgrading the ONTAP Mediator in a MetroCluster configuration]
...
* Procedure for <<rhel7x, RHEL 7.x>>
* Procedure for <<rhel8x, RHEL 8.x>>
* Procedure for <<centos7x, CentOS 7.x>>
* Procedure for <<centos8x, CentOS 8.0.1095 or later>>
...
Because the latest version of the 8.0 (CentOS 8.0.1905) core resides in the CentOS Vault, you must provide access to the matching kernel-devel package to compile the needed kernel module.
