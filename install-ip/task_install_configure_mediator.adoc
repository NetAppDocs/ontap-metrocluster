...
. [[step1-rpm]] Directly install the kernel-devel package:
+
...
// 21 APR 2021, ONTAPEX-133437
// 05 MAY 2021, review comment in IDR-67
// 03 SEP 2021, BURT 1399705
// 03 FEB 2022, BURT 1448684
// 14 FEB 2022, Issue 139
