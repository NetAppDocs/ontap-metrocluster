...
Because the latest version of the 8.0 (CentOS 8.0.1905) core resides in the https://vault.centos.org[CentOS Vault], you must provide access to the matching kernel-devel package to compile the needed kernel module.
