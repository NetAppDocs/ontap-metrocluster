...
+
NOTE: If the ONTAP Mediator is down, the `metrocluster configuration-settings mediator remove` command still prompts you to enter the username and password for the Mediator admin user account and proceeds to remove the ONTAP Mediator service.
