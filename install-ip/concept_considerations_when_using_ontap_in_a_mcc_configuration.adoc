...
---
= ONTAP operation requirements in a MetroCluster IP configuration
:icons: font
:imagesdir: ../media/
...
+
image::../media/svm_dr_normal_behavior.gif["SVM disaster recovery during steady state operation"]
...
+
image::../media/svm_dr_image_2.gif["SVM updates after switchover"]
...
image::../media/svm_dr_resynchronization.gif["SVM disaster recovery resynchronization"]
