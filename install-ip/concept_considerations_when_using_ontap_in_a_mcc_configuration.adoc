...
Beginning in ONTAP 9.11.1, both clusters can have a source SVM in an SVM DR relationship in a MetroCluster configuration as shown in the following image.

image:../media/svmdr_new_topology.png[SVM DR Topology]
