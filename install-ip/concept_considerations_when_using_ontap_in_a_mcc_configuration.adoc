...
* SVM migration is not supported with FabricPool when the source or destination is a MetroCluster cluster. 
+
link:docs.netapp.com/us-en/ontap/svm-migrate/index.html[Learn more about SVM data mobility^]. 
