...
* If you are using these steps to replace an existing RCF, you should have already moved the cluster LIFs to the partner switch to enable non-disruptive cluster operations. Refer to link:switch-move-cluster-lifs.html[Move cluster LIFs] for more information. 
...
* If you are using these steps to upgrade or downgrade the switch firmware, you should have already moved the cluster LIFs to the partner switch to enable non-disruptive cluster operations. Refer to link:switch-move-cluster-lifs.html[Move cluster LIFs] for more information. 


* You must use the supported switch software version. Refer to the https://hwu.netapp.com[NetApp Hardware Universe].
...
. Repeat the previous steps on the remaining three IP switches in the MetroCluster IP configuration.

. If you are upgrading the firmware on existing switches, modify all cluster LIFs to re-enable auto-revert:
+
NOTE: For a switch firmware or RCF update, you disabled auto-revert as part of the step to link:switch-move-cluster-lifs.html[Move the cluster LIFs]. If you are installing the firmware on the switch for the first time, you can skip this step.  
+
...
* If you are using these steps to replace the RCF, you should have already moved the cluster LIFs to the partner switch to enable non-disruptive cluster operations.  Refer to link:switch-move-cluster-lifs.html[Move cluster LIFs] for more information. 
...
. If you are updating the RCF on existing switches, modify all cluster LIFs to re-enable auto-revert:
+
NOTE: For a switch firmware or RCF update, you disabled auto-revert as part of the step to link:switch-move-cluster-lifs.html[Move the cluster LIFs]. If you are installing an RCF on the switch for the first time,  you can skip this step.  
+
.. Re-enable auto-revert:
+
`network interface modify -vserver Cluster -lif * -auto-revert true`
