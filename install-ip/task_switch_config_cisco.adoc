...
== Move cluster LIFs before a Cisco switch or RCF upgrade

When you upgrade the switch firmware or reference configuration file (RCF), you move cluster LIFs to the partner switch to enable non-disruptive cluster operations during the upgrade. 
