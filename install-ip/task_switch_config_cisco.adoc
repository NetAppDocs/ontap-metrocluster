...
. If auto-revert is disabled, modify all cluster LIFs to re-enable auto-revert:
+
NOTE: If you are performing these steps as part of another procedure, such as a switch replacement or upgrade, you should have disabled auto-revert as part of the steps to link:switch-move-cluster-lifs.html[Move the cluster LIFs].  
+
