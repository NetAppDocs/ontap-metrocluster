...
* If you are using these steps as part of another procedure, such as a switch replacement or upgrade, you should have already moved the cluster LIFs to the partner switch to enable non-disruptive cluster operations. Refer to link:switch-move-cluster-lifs.html[Move cluster LIFs] for more information. 
