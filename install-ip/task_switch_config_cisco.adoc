...
== Migrate cluster LIFs before a Cisco switch or RCF upgrade
...
+
NOTE: If you are configuring the switches for the first time, you can skip this task.
...
cluster1-01/cdp
            ...
            e0d    IP_switch_A2              Ethernet1/7       N3K-C3232C
cluster1-02/cdp
            e0a    IP_switch_A1              Ethernet1/8       N3K-C3232C
            e0d    IP_switch_A2              Ethernet1/8       N3K-C3232C
cluster1-03/cdp
            e0a    IP_switch_A1              Ethernet1/1/1     N3K-C3232C
            e0b    IP_switch_A2              Ethernet1/1/1     N3K-C3232C
cluster1-04/cdp
            e0a    IP_switch_A1              Ethernet1/1/2     N3K-C3232C
            e0b    IP_switch_A2              Ethernet1/1/2     N3K-C3232C
cluster1::*>
----
====
...
. Verify that the cluster ports have migrated to the ports hosted on cluster switch IP_switch_A2. This might take a few seconds.
+
`network interface show -role cluster`
+
.Show example 
