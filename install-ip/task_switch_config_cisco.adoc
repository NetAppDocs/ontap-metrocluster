...
+
NOTE:  This example shows the minimum information required to configure the RCF, additional options can be configured after the RCF has been applied. For example, you can configure SNMPv3, NTP, SCP/SFTP after you have applied the RCF. You cannot configure any setting that impacts switch port traffic flow. 
+
----
