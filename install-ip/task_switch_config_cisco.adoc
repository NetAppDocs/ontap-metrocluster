...
* If you are using these steps as part of another procedure, such as a switch replacement or upgrade, you might need to move the cluster LIFs to the partner switch to enable non-disruptive cluster operations. link:task_install_and_cable_the_mcc_components.html[Learn about configuring the MetroCluster IP switches].
