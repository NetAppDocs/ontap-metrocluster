...
*Note:* If you are using internal and external drives, you first initialize the MetroCluster with only the internal drives. You then manually connect the external shelf after you complete your installation or setup task. A minimum of 12 internal drives are required for the root partition. The root internal drives should be placed from slot 1. For example, for 12 internal drives, use slots 1-3, 6-8, 12-14, and 18-20.
