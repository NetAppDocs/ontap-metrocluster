...
=== ADP and disk assignment on AFF C250, AFF A250 systems and FAS500f systems
...
The same disk assignment guidelines and rules for AFF C250 and AFF A250 systems apply to FAS500f systems. Refer to the <<ADP and disk assignment on AFF C250 and AFF A250 systems>> table for disk assignment on FAS500f systems.
