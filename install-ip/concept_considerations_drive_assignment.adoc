...
* To avoid failed or stale aggregates, ensure that you remove disk ownership for any stale disks on the external disk shelf before you attach it to the controller. 
a|
Not applicable
