...
[.lead]
Beginning with ONTAP 9.4, MetroCluster IP configurations support new installations using ADP (Advanced Drive Partitioning). In most configurations, partitioning and disk assignment are performed automatically during the initial configuration of the MetroCluster sites.
...
=== ADP and disk assignment on AFF C250, AFF A250, and FAS500f systems
...
The same disk assignment guidelines and rules for AFF C250 and AFF A250 systems apply to FAS500f systems. Refer to the <<ADP and disk assignment on AFF C250, AFF A250, and FAS 500f systems>> table for disk assignment on FAS500f systems.
