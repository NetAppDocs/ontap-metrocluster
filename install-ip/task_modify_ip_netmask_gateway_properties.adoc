...
summary: You can change the following properties of a MetroCluster IP interface, IP address and mask, gateway, and VLAN. You can use any combination of parameters to update.
---
...
[.lead]
Starting from ONTAP 9.10.1, you can change the following properties of a MetroCluster IP interface: IP address and mask, gateway, and VLAN. You can use any combination of parameters to update.
...
. Update the IP address, netmask, and gateway for a single node and interface using the following command:
----
...
----
cluster_A::*> metrocluster configuration-settings connection check
  (metrocluster configuration-settings connection check)
----

//== Move MetroCluster interfaces to another subnet
//Move the MetroCluster interfaces to another subnet.
