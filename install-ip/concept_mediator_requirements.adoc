...
* Beginning with ONTAP 9.18.1 and ONTAP Mediator 1.11, up to ten MetroCluster configurations can be managed simultaneously by a single ONTAP Mediator instance. In earlier releases, ONTAP Mediator can support up to five MetroCluster configurations simultaneously.
