...
Beginning with ONTAP Mediator 1.12.1 and ONTAP 9.19.1, you can use the same ONTAP Mediator instance to monitor a four-node MetroCluster IP configuration and a SnapMirror active sync cluster peer relationship if the following requirements are met:
