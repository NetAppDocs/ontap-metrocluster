...
+
link:concept_configure_the_ontap_mediator_for_unplanned_automatic_switchover.html#installing-or-upgrading-the-ontap-mediator-service[Installing or upgrading the ONTAP Mediator service]
...
. link:../install-ip/concept_configure_the_ontap_mediator_for_unplanned_automatic_switchover.html#installing-or-upgrading-the-ontap-mediator-service[Reinstall the Mediator service].
. Add the Mediator service to the ONTAP configuration:
+
