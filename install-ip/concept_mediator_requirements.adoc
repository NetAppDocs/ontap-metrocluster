...
Beginning with ONTAP 9.19.1 and ONTAP Mediator 1.12, you can configure a HTTPS-based Mediator to monitor your MetroCluster IP configuration. HTTPS is a secure protocol for communication. Configuring a HTTPS-based Mediator has the following benefits:
