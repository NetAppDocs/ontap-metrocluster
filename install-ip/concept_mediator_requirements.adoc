...
* Beginning with ONTAP 9.18.1, up to ten MetroCluster configurations can be managed simultaneously by a single ONTAP Mediator instance. In releases earlier than ONTAP 9.18.1, ONTAP Mediator can support up to five MetroCluster configurations simultaneously.
