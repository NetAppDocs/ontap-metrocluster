...
Beginning with ONTAP 9.19.1GA and ONTAP Mediator 1.12.1, ONTAP Mediator configured with HTTPS has the following support for monitoring multiple MetroCluster IP configurations:
