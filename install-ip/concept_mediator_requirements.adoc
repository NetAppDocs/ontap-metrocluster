...
Support for monitoring multiple MetroCluster IP configurations depend on whether you are configuring ONTAP Mediator for iSCSI or HTTPS. For more information see <<Use ONTAP Mediator to monitor multiple MetroCluster IP configurations>>.
