...
ONTAP Mediator configured with HTTPS has the following support for monitoring multiple MetroCluster IP configurations. The support depends on the ONTAP Mediator version, the host OS specification, and whether the configuration is a four-node or eight-node MetroCluster IP configuration.
...
| 1.12 | 1 | 1 | N/A
| 1.12.1 and later | 1| 1 | On hosts with fewer than 8 CPUs and less than 16GB of RAM 
| 1.12.1 and later | 10| 5 | On hosts with 8 CPUs and 16GB of RAM 
|===
