...
* ONTAP 9.13.1 or later and RCF file version 2.00 is required to use a platform other than FAS8200 or AFF a300 in "MetroCluster 4". 
...
* If you are upgrading from older RCF files, the cabling configuration might be using ports in "MetroCluster 4" (ports 25/26 and 29/30). 
