...
AFF A250, ASA A250 | <<table_1_cisco_3232c_9336c,Cisco 3232C or Cisco 9336C platform port assignments (group 1)>>
|
 ...
 * <<table_3a_cisco_3232c_9336c,Cisco 3232C or Cisco 9336C platform port assignments (group 3a - 25G)>> 
 * <<table_3b_cisco_3232c_9336c,Cisco 3232C or Cisco 9336C platform port assignments (group 3b - 100G)>>
...
Review the platform port assignments to cable an AFF A30, AFF C30, AFF C60, or FAS50 system to a Cisco 3232C or 9336C switch using a four-port 25G Ethernet card.
...
Review the platform port assignments to cable an AFF A30, AFF C30, AFF C60, or FAS50 system to a Cisco 3232C or 9336C switch using a two-port 100G Ethernet card.
...
image::../media/mccip-cabling-fas8200-a300-updated.png[Shows Cisco 3232C or Cisco 9336C platform port assignments]
...
image:../media/mccip-cabling-a70-fas70-a90-c80-fas90-a1k-updated.png[Shows Cisco 3232C or Cisco 9336C platform port assignments]
