...
FAS50 
AFF C60
*Note:* These configurations use 25G connections.| <<table_3a_cisco_3232c_9336c,Cisco 3232C or Cisco 9336C platform port assignments (group 3A - 25G connections)>>
|
AFF A30, AFF C30

FAS50 
AFF C60
*Note:* These configurations use 100G connections.| <<table_3b_cisco_3232c_9336c,Cisco 3232C or Cisco 9336C platform port assignments (group 3B - 100G connections)>>
