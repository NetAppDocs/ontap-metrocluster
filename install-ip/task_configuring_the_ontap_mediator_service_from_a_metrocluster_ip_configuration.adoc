...
+
The following command can only be used in advanced privilege level and should not be used without reviewing the link:concept-risks-limitations-automatic-switchover.html[Risks and limitations of using MetroCluster automatic forced switchover].
+
