...
* Beginning wiht ONTAP Mediator 1.12, you can install ONTAP Mediator with support for iSCSI, HTTPS, or both. If you installed ONTAP Mediator with support for iSCSI only, you can't use the steps to configure ONTAP Mediator with iSCSI. 
