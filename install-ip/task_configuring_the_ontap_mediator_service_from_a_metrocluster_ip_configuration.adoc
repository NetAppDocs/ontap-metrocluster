...
* Support for monitoring multiple MetroCluster IP configurations using a single ONTAP Mediator instance depends on whether you configure ONTAP Mediator with HTTPS or iSCSI. For more information, refer to link:concept_mediator_requirements.html#mediator-multiple-mccip[Use ONTAP Mediator to monitor multiple MetroCluster IP configurations].
