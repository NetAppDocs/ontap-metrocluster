...
* Beginning with ONTAP 9.19.1 and ONTAP Mediator 1.12, you can use configure a HTTPS based Mediator to monitor your MetroCluster configuration.
...
. Add ONTAP Mediator to ONTAP. The steps depend on whether you want to use an IPv4 or IPv6 address and whether you want to use the HTTPS or iSCSI protocol.
+
[NOTE]
====
...
* You must be running ONTAP 9.19.1 or later and ONTAP Mediator 1.12 or later to use HTTPS.
