...
+
NOTE: You must be running ONTAP 9.18.1 and ONTAP Mediator 1.11 to use IPv6 with ONTAP Mediator in a MetroCluster IP configuration.
+
[role="tabbed-block"]
====
.Use IPv4
...
Beginning with ONTAP 9.18.1, IPv6 is supported in ONTAP Mediator 1.11. 
+
