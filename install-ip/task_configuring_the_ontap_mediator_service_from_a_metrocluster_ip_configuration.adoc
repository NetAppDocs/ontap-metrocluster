...
+
----
1-ontap-mediator.rules              make_self_signed_certs.sh
config_migration                    netapp_sudoers
config.pyc                          ontap_mediator.config.yaml
__init__.pyc                        ontap_mediator.constants.yaml
intermediate.crt                    ontap_mediator.user_config.yaml
intermediate.key                    ontap_mediator_server.crt
intermediate.srl                    ontap_mediator_server.csr
logging.conf.yaml                   ontap_mediator_server.key
openssl_ca.cnf                      ontap_mediator_server_chain.crt
openssl_intermediate.cnf            root_ca.crt
openssl_server.cnf                  root_ca.key
----
