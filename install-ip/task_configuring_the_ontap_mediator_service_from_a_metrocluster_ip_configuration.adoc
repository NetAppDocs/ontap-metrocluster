...
CAUTION: Beginning with ONTAP 9.12.1, you can enable the MetroCluster automatic forced switchover feature in a MetroCluster IP configuration. This feature is an extension of the Mediator-assisted unplanned switchover. Before you enable this feature, review link:concept-ontap-mediator-supports-automatic-unplanned-switchover.html#features-available-beginning-with-ontap-9.12.1[Risks and limitations of using MetroCluster automatic forced switchover].
...
+
IMPORTANT: Before using this command, review link:concept-ontap-mediator-supports-automatic-unplanned-switchover.html#features-available-beginning-with-ontap-9.12.1[Risks and limitations of using MetroCluster automatic forced switchover].
+
