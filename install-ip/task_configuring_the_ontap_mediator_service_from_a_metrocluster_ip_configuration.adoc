...
* If you want to use a single ONTAP Mediator instance to monitor one or more MetroCluster IP configurations, you should configure ONTAP Mediator using iSCSI instead of HTTPS. 
====
