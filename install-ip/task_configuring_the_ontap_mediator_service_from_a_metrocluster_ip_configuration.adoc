...
* Beginning with ONTAP Mediator 1.12, you can install ONTAP Mediator with support for iSCSI and HTTPS, or HTTPS only. If you installed ONTAP Mediator with support for HTTPS only, you can't use the steps to configure ONTAP Mediator with iSCSI.  For more information, see link:https://review.docs.netapp.com/us-en/ontap_ontapdoc-3807-mediator-112-release-ccoyle/mediator/index.html#https-iscsi-installation[HTTPS and iSCSI installation options for MetroCluster IP^].
