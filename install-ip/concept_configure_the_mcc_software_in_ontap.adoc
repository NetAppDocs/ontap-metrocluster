...
a|
xref:concept_configure_the_mcc_software_in_ontap.html#verifying-disk-assignment-for-pool-1-disks[Verifying disk assignment for pool 1 disks]
a|
...
a|
xref:concept_configure_the_mcc_software_in_ontap.html#verifying-or-manually-performing-pool-1-drives-assignment[Manually assigning drives for pool 1 (ONTAP 9.4 or later)]
a|
...
xref:concept_configure_the_ontap_mediator_for_unplanned_automatic_switchover.delete_me_mcc_ip_cabling_a_aff_a250_or_fas500f_to_a_broadcom_bes_53248_switch[Configuring the ONTAP Mediator service for unplanned automatic switchover]
