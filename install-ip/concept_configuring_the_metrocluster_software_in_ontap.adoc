---
permalink: install-ip/concept_configuring_the_metrocluster_software_in_ontap.html
sidebar: sidebar
keywords: 
summary: ''
---
...
link:concept_preparing_for_the_metrocluster_installation.md#[Considerations for MetroCluster IP configuration]
...
To determine if your system requires manual disk assignment, you should review link:concept_preparing_for_the_metrocluster_installation.md#[Considerations for automatic drive assignment and ADP systems in ONTAP 9.4 and later].
...
. Proceed to link:concept_configuring_the_metrocluster_software_in_ontap.md#[Setting up ONTAP].
...
link:concept_preparing_for_the_metrocluster_installation.md#[Considerations for automatic drive assignment and ADP systems in ONTAP 9.4 and later]
...
a|
link:concept_configuring_the_metrocluster_software_in_ontap.md#[Verifying disk assignment for pool 1 disks]
a|
...
a|
link:concept_configuring_the_metrocluster_software_in_ontap.md#[Manually assigning drives for pool 1 (ONTAP 9.4 or later)]
a|
...
a|
link:concept_configuring_the_metrocluster_software_in_ontap.md#[Manually assigning disks for pool 1 (ONTAP 9.3)]
|===
...
Details for determining whether your system requires manual disk assignment are included in link:concept_preparing_for_the_metrocluster_installation.md#[Considerations for automatic drive assignment and ADP systems in ONTAP 9.4 and later].
...
link:concept_preparing_for_the_metrocluster_installation.md#[Considerations for using ONTAP Mediator or MetroCluster Tiebreaker]
