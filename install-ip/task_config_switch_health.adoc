...
If you have Broadcom switches, you can use the following steps to configure SNMPv3 for health monitoring. 
...
If you have Cisco switches, you can use the following steps to configure SNMPv3 for health monitoring.
...
If you have NVIDIA switches, you can use the following steps to configure SNMPv3 for health monitoring.
