...
---
= MetroCluster IP requirements for shared layer 2 and layer 3 networks
:icons: font
:imagesdir: ../media/
...
image::../media/MCC_layer2.png["MetroCluster layer 2 network configuration"]
...
image::../media/mcc_layer3_backend.png["MetroCluster layer 3 backend network configuration"]
...
image::../media/switch_traffic_with_cisco_switches.png["Required settings when using NetApp validated Cisco switches for MetroCluster traffic"]
...
image::../media/switch_traffic_with_broadcom_switches.png["Required settings for shared network when using Broadcom IP switches"]
