...
+
If you have a 36-port Cisco 9336C-FX2 switch and you are using dedicated switches to attach NS224 shelves, use the tables in link:port_usage_3232c_9336c.html[Platform port assignments for Cisco 3232C or 36-port Cisco 9336C-FX2 switches]
+
