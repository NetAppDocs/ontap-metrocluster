...
. If you change the switch from EFOS 3.4.x.x to EFOS 3.7.x.x or vice version then follow the following two procedures to apply the correct configuration (RCF):
.. <<Resetting the Broadcom IP switch to factory defaults>>
