...
+
NOTE: The port or ports might be in breakout mode so the port representation you must use in the command might be different than what is stated in the file.
+
[role="tabbed-block"]
====
