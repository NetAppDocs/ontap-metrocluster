...
If you are using a QSFP-SFP adapter, you might need to configure the ISL port in native speed mode instead of breakout speed mode, refer to link:concept-requirements-isls.html[Considerations for ISLs] for more information. 
