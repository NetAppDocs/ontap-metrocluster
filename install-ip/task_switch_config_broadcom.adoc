...
NOTE: Your configuration requires additional licenses (6 x 100-Gb port license) if your configuration meets both the following criteria:

. The platform type is either FAS8300, AFF A400, or FAS8700.
. Ports 53 and 54 are used as 40-Gb/100-Gb ISLs to the remote site.
