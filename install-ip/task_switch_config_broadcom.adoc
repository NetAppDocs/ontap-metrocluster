...
IMPORTANT: The following configurations require additional licenses (6x 100-Gb port license):

. You are configuring the MetroCluster configuration with platform type FAS8300, AFF A400, or FAS8700.
. You are using ports 53 and 54 as 40-Gb/100-Gb ISLs to the remote site.
