...
AFF C60 a| 
* <<table_3a_nvidia_sn2100,NVIDIA SN2100 platform port assignments (group 3a -25G connections)>>
* <<table_3b_nvidia_sn2100,NVIDIA SN2100 platform port assignments (group 3b -100G connections)>>
| 
FAS8300
...
Review the platform port assignments to cable an AFF C30, AFF A30, FAS50, or AFF C60 system to a NVIDIA SN2100 switch:
