...
+
Learn about link:..install-ip/concept-ontap-mediator-supports-automatic-unplanned-switchover.html[how the ONTAP Mediator supports automatic unplanned switchover].
