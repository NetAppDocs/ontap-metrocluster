...
* Beginning with ONTAP 9.13.1, if the above conditions are met and a fan or hardware failure, for example, a power supply unit, NVRAM battery, or Service Processor heartbeat failure, or high or low temperature, initiates an environmental shutdown. 
