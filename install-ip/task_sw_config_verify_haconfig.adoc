...
. Use the procedures for negotiated switchover, healing, and switchback in https://docs.netapp.com/ontap-9/topic/com.netapp.doc.dot-mcc-mgmt-dr/home.html[MetroCluster management and disaster recovery]
...
link:concept_mediator_requirements.html[Configure the ONTAP Mediator service for unplanned automatic switchover]
...
link:concept_considerations_differences.html[Considerations for using ONTAP Mediator or MetroCluster Tiebreaker]
