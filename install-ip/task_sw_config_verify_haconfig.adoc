...
+
https://docs.netapp.com/us-en/ontap/index.html[ONTAP System Manager (Versions 9.7 and later)]
...
* Starting with ONTAP 9.9.1, if you are using a layer 3 configuration, you must also specify the `-gateway` parameter when creating MetroCluster IP interfaces. Refer to link:concept_considerations_layer_3.html[Considerations for layer 3 wide-area networks].
...
+
Cluster Management with the CLI contains additional information under the section _Managing configuration backups_.
