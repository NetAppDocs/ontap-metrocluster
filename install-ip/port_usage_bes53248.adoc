...
Review the platform port assignments to cable an AFF C30, AFF A30, FAS50, or AFF C60 system to a Broadcom BES-53248 switch using  a four-port 25G Ethernet card.
