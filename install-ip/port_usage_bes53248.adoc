...
* Two MetroCluster configurations consisting of FAS2750/A220 only, or FAS500f/A250 only, you must select MetroCluster port groups 3 and 4.
* Two MetroCluster configurations where one MetroCluster is type FAS2750/A220 and the other is FAS500f/A250, you must select port groups 3 and 4 for one, and port groups 1 and 2 for the other.
