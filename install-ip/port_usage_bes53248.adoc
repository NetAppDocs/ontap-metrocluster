...
The switches cannot be used with ISL ports of different speeds (for example, a mix of 25 Gbps ISL and 10 Gbps ISL ports).
//1386105 2021.11.23
...
. Only a single MetroCluster using A320 systems can be connected to the switch.
+
