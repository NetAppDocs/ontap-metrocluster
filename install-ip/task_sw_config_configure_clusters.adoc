...
+
`metrocluster configuration-settings interface create -cluster-name _cluster-name_ -home-node <node_name> -home-port e5a -address _ip-address_ -netmask _netmask_`
+
...
+
`metrocluster configuration-settings interface create -cluster-name _cluster-name_ -home-node <node_name> -home-port e5b -address _ip-address_ -netmask _netmask_`
+
