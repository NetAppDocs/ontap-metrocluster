...
NOTE: If you are running ONTAP 9.10.1 and later, choose the MetroCluster IP addresses carefully because you cannot change them after initial configuration.
