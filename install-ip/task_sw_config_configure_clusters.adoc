...
* If you are running ONTAP 9.10.1 or earlier, choose the MetroCluster IP addresses, netmask, VLAN, and other properties carefully because you cannot change them after initial configuration. 
