...
NOTE: The MetroCluster IP and connected switch ports do not come online until after you create the MetroCluster IP interfaces. 
...
+
CAUTION: Using 169.254.17.x and 18.x IP addresses when you create MetroCluster IP interfaces is not supported.
+
