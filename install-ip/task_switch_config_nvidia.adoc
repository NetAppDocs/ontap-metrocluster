...
+
NOTE: If the port is in breakout mode, the port name you must specify in the command might be different than what is stated in the RCF banner. You can use the RCF cabling files to find the port name. 
+
`net show interface`
