...
.Cumulus 4.4.x
--
The following example commands configure the hostname (IP_switch_A_1), IP address (10.10.10.10), netmask (255.255.255.0 (24)), and gateway (10.10.10.1) on a switch running Cumulus 4.4.x. 
----
...
--
The following example commands configure the hostname (IP_switch_A_1), IP address (10.10.10.10), netmask (255.255.255.0 (24)), and gateway (10.10.10.1) on a switch running Cumulus 5.4.x. or later. 
----
...
. Reboot the switch after setting the DAC option on the switch ports:
+
`sudo reboot`
+
