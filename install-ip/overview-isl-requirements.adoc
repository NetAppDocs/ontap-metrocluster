...
| link:concept-requirement-and-limitations-mcc-compliant-switches[Considerations when using MetroCluster Compliant switches] | Describes the requirements for MetroCluster-compliant switches. 
