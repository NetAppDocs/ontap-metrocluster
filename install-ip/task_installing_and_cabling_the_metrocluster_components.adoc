---
permalink: install-ip/task_installing_and_cabling_the_metrocluster_components.html
sidebar: sidebar
keywords: 
summary: ''
---
...
link:task_installing_and_cabling_the_metrocluster_components.md#[Platform port assignments for Cisco 3232C or Cisco 9336C switches]
