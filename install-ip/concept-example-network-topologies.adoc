...
image::../media/mcc_ip_two_mccs_sharing_the_same_shared_network_sx.gif["MetroCluster IP cabling with two configurations sharing the same intermediate network"]
