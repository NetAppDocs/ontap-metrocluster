...
* If you are expanding a regular MetroCluster configuration that doesn't support connecting NS224 storage to switch and you want to add a MetroCluster configuration that has switch attached NS224 storage, review the following information:
