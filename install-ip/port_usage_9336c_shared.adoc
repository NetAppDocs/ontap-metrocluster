...
+
This means that when you generate the RCF for your configuration, you might need to select the platforms in the RcfFileGenerator tool in the following order:
+
