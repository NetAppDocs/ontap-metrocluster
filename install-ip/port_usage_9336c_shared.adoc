...
.Cisco 9336C-FX2 shared switch platform port assignments (group 3a)
...
Review the platform port assignments to cable an AFF A30, AFF C30, FAS50, or AFF C60 system that is not connecting switch-attached NSS24 shelves to a Cisco 9336C-FX2 shared switch:
