...
+
If you have a 12-port Cisco 9336C-FX2 switch not connecting NS224 storage, use the tables in link:port-usage-9336c-fx-2-12-port.html[Platform port assignments for 12-port Cisco 9336C-FX2 switches ].
+
NOTE: The 12-port Cisco 9336C-FX2 switch does not support connecting NS224 storage to the MetroCluster switch.
+
