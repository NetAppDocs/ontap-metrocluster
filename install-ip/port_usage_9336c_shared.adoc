...
+
To generate the RCF, you might need to select the platform that supports NS224 storage in drop-down field 2 and the platform that doesn't support NS224 on drop-down field 1.
