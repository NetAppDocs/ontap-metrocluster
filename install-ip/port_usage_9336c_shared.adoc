...
+
If your second MetroCluster or DR group do not connect NS224 shelves to the MetroCluster switch, follow the <<tables_not_connecting_ns224,cabling tables for controllers not connecting switch-attached NS224 shelves>>.
