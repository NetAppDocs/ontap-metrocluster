...
*Note 1*: If you are using an X91440A adapter (40Gbps), then use ports e4a and e4e, or e4a and e8a. If you are an X91153A adapter(100Gbps), then use either ports e4a and e4b or e4a and e8a.
...
*Note 1*: If you are using an X91440A adapter (40Gbps), then use ports e4a and e4e or e4a and e8a. If you are an X91153A adapter(100Gbps), then use ports e4a and e4b or e4a and e8a.
