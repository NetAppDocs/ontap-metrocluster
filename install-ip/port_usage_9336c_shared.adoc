...
Use the following tables to determine which cabling table you should follow for controllers connecting to switch-attached NS224 shelves.
...
Use the following tables to determine which cabling table you should follow for controllers that are not connecting to switch-attached NS224 shelves.
