...
** In the link:https://mysupport.netapp.com/site/tools/tool-eula/rcffilegenerator[RcfFileGenerator^] tool, you must select the platform that supports NS224 switch-attached NS224 storage first, then select the platform that doesn't support NS224 switch-attached NS224 storage.
+
