...
* <<table_1a_cisco_9336c_fx2,Cisco 9336C-FX2 shared switch platform port assignments (group 1a - 25GB connections) >> 
* <<table_1b_cisco_9336c_fx2,Cisco 9336C-FX2 shared switch platform port assignments (group 1b - 100GB connections) >> 
|
AFF A320
...
Review the platform port assignments to cable an AFF A50 system that is connecting switch-attached NSS24 shelves to a Cisco 9336C-FX2 shared switch using a four-port 25G Ethernet card.
...
Review the platform port assignments to cable an AFF A50 system that is connecting switch-attached NSS24 shelves to a Cisco 9336C-FX2 shared switch using a two-port 100G Ethernet card.
...
Review the platform port assignments to cable an AFF A30, AFF C30, or AFF C60 system that is not connecting switch-attached NSS24 shelves to a Cisco 9336C-FX2 shared switch using a four-port 25G Ethernet card:
...
Review the platform port assignments to cable an AFF A30, AFF C30, FAS50, or AFF C60 system that is not connecting switch-attached NSS24 shelves to a Cisco 9336C-FX2 shared switch using a a two-port 100G Ethernet card:
