...
sidebar: sidebar
keywords: metrocluster, ip, configuration, hardware, component, interconnect, part
...
link:concept_prepare_for_the_mcc_installation.html[Considerations for MetroCluster IP configuration]
...
link:task_install_and_cable_the_mcc_components.html[Cabling the cluster peering connections]
