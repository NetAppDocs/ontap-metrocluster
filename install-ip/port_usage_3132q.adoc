...
[cols=2*,options="header"]Cisco 3132Q-V platform port assignments (group 1)
|===
| If your system is...
...
| AFF A800, ASA A800 | <<table_3_cisco_3132q,Cisco 3132Q-V platform port assignments (group 2)>>
