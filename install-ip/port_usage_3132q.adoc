...
NOTE: If you configure the switch for MetroCluster FC to IP transition, port 5 and port 6 are used. Refer to the RcfFileGenerator and the generated cabling files for more details on cabling this configuration type. For all other connections, you can use the port usage assignments in the following tables.
