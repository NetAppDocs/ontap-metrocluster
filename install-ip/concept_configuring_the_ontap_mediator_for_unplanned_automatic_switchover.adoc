---
permalink: install-ip/concept_configuring_the_ontap_mediator_for_unplanned_automatic_switchover.html
sidebar: sidebar
keywords: 
summary: ''
---
...
+
link:concept_configuring_the_ontap_mediator_for_unplanned_automatic_switchover.md#[Installing or upgrading the ONTAP Mediator service]
...
+
link:concept_configuring_the_ontap_mediator_for_unplanned_automatic_switchover.md#[Uninstalling the ONTAP Mediator service]
 ...
 ** 31784
 ** 3260
* If using a third-party firewall: refer to link:concept_configuring_the_ontap_mediator_for_unplanned_automatic_switchover.md#[Firewall requirements for ONTAP Mediator]
...
link:concept_configuring_the_ontap_mediator_for_unplanned_automatic_switchover.md#[Guidelines for upgrading the ONTAP Mediator in a MetroCluster configuration]
