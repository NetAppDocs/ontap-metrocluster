...
** On AFF A1K and AFF A90 systems, the ISL speed must be at least 100Gbps. Using a different ISL speed requires a Feature Product Variance Request (FPVR). To file an FPVR, contact your sales team.
