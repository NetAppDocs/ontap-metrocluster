...
** Beginning with ONTAP 9.18.1, platforms with a MetroCluster IP backend port speed of 100Gbps require a minimum ISL link speed of 100Gbps. Using a different ISL speed requires a Feature Product Variance Request (FPVR). To file an FPVR, contact your NetApp sales team.
+
