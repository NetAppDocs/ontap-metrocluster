...
** Beginning with ONTAP 9.18.1, platforms with a MetroCluster IP backend port speed of 100G  require a minimum ISL link speed of 100Gbps. Using a different ISL speed requires a Feature Variance Request (FPVR). To file an FPVR, please contact your sales team.
** Beginning with ONTAP 9.18.1, platforms with a MetroCluster IP backend port speed option of 25G require a minimum ISL link speed of 10Gbps.
