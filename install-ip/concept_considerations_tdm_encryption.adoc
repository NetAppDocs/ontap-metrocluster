...
If you are sharing ISLs with a non-MetroCluster network, you must follow the guidelines in the section link:concept_considerations_layer_2.html[Considerations for sharing private layer 2 networks].
