...
link:concept_considerations_drive_assignment.html[Learn about the considerations for automatic drive assignment and ADP systems in ONTAP 9.4 and later]
