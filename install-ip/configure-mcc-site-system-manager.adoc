...
summary: Beginning with ONTAP 9.8, you can manage MetroCluster IP configuration operations with System Manager.  After setting up two clusters and peering them, you configure each cluster.
---
...
[.lead]
Beginning with ONTAP 9.8, you can manage MetroCluster IP configuration operations with System Manager.  After setting up two clusters and peering them, you configure each cluster.
