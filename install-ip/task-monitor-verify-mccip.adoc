...
.About this task 
include::https://raw.githubusercontent.com/NetAppDocs/ontap-systems-switches/main/_include/monitor-verify-switches.adoc[]

.Related information

* link:https://docs.netapp.com/us-en/ontap-systems-switches/switch-cshm/monitor-troubleshoot.html[Troubleshoot alerts^]