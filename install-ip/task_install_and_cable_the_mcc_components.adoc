...
==== Cabling eight-node MetroCluster configurations for transition and upgrade procedures

Some procedures require the addition of second four-node DR group to create a temporary or permanent eight-node configuration.
