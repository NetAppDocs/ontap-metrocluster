...
sidebar: sidebar
keywords: install, cabling, cable, component, storage, controller, ip, isl, link, site, management, network
...
link:task_install_and_cable_the_mcc_components.html[Platform port assignments for Cisco 3232C or Cisco 9336C switches]
