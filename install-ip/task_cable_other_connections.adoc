...
+
NOTE: MetroCluster IP systems do not have dedicated high-availability (HA) ports. When using the ONTAP Hardware Systems Documentation to install your platform, you should not follow the instructions to cable cluster and HA ports.
