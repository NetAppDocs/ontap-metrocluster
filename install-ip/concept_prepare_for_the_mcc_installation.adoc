...
NOTE: You must follow the basic ISL requirements: link:concept_prepare_for_the_mcc_installation.md#[Considerations for ISLs]
...
link:concept_prepare_for_the_mcc_installation.md#[Considerations for using MetroCluster compliant switches]
...
* The network must meet the requirements as outlined in the sections link:concept_prepare_for_the_mcc_installation.md#[MetroCluster ISL requirements in shared networks], link:concept_prepare_for_the_mcc_installation.md#[ISL cabling requirements], and link:concept_prepare_for_the_mcc_installation.md#[Required settings on intermediate switches].
...
If you are sharing ISLs with a non-MetroCluster network, you must follow the guidelines in the section link:concept_prepare_for_the_mcc_installation.md#[Considerations for sharing private layer 2 networks].
