...
NOTE: You must follow the basic ISL requirements: xref:concept_prepare_for_the_mcc_installation.html#considerations-for-isls[Considerations_for_ISLs]
...
xref:concept_prepare_for_the_mcc_installation.html#considerations-for-using-metrocluster-compliant-switches[Considerations for using MetroCluster compliant switches]
