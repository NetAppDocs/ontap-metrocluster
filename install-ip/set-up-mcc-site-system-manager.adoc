...
.What's Next?
After both clusters have been set up, initialized, and configured, perform the link:https://docs.netapp.com/us-en/ontap-metrocluster/install-ip/set-up-mcc-peering-system-manager.html[Set up MetroCluster IP peering] procedure.
