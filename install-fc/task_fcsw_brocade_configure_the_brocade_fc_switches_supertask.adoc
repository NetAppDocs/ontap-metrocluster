...
* You must provide any additional settings not documented in this procedure if they are required on the ISL links because of your specific DWDM configuration.
...
If your configuration is running ONTAP 9.0 or earlier, see the link:concept_port_assignments_for_fc_switches_when_using_ontap_9_0.html[Port assignments for FC switches when using ONTAP 9.0].
