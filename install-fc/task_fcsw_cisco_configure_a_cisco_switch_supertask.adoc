...
---
= Configure Cisco switches manually in a MetroCluster FC configuration
:icons: font
:imagesdir: ../media/
...
You need to verify that you are using the specified port assignments when you cable the FC switches. Refer to link:concept_port_assignments_for_fc_switches_when_using_ontap_9_1_and_later.html[Port assignments for FC switches]
...
image::../media/fcip_ports_dual_isl.gif["Diagram showing FCIP ports with dual ISL configuration on each switch"]
