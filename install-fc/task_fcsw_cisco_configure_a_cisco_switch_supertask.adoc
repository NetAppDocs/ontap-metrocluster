...
NOTE: On each switch, the IPStorage interfaces IPStorage1/1 and IPStorage1/2 must have different IP addresses.
 ...
 .. Enable the port: `no shutdown`
 .. Exit configuration mode: `exit`
 .. Repeat steps link:task_fcsw_cisco_configure_a_cisco_switch_supertask.md#SUBSTEP_4717B5874EFB4B0897BFFFE2583F94D2[a] through link:task_fcsw_cisco_configure_a_cisco_switch_supertask.md#SUBSTEP_9D4A074A3183488C9D965EB8CDCD6F1A[f] to configure the IPStorage1/2 GbE interface with a different IP address.
