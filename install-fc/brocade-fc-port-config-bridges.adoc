...
* Port usage for the Brocade 6505, and G610 switches in an eight-node MetroCluster configuration is not shown. Due to the limited number of ports, port assignments must be made on a site-by-site basis depending on the controller module model and the number of ISLs and bridge pairs in use.
...
* On Brocade 6505, G610, G620, G620-1, G630, and G630-1 switches, you can cable additional bridges to ports 12-15.
...
* On Brocade 6505, G610, G620, G620-1, G630, and G630-1 switches, additional bridges ports 12-15.
* On Brocade 6510 and DCX 8510-8 switches, you can cable additional bridges to ports 12-19.
