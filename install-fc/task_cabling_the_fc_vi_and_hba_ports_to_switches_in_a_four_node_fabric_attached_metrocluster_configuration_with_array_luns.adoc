---
permalink: install-fc/task_cabling_the_fc_vi_and_hba_ports_to_switches_in_a_four_node_fabric_attached_metrocluster_configuration_with_array_luns.html
sidebar: sidebar
keywords: 
...
xref:concept_switch_ports_required_for_a_eight_node_metrocluster_configuration_with_array_luns.adoc[Switch ports required for a MetroCluster configuration with array LUNs]
