...
---
= Virtual IP and Border Gateway Protocol in a MetroCluster configuration
:icons: font
:imagesdir: ../media/
...
Review the following guidelines and illustration when planning your layer 3 solution. For details on implementing VIP and BGP in ONTAP, refer to link:https://docs.netapp.com/us-en/ontap/networking/configure_virtual_ip_@vip@_lifs.html[Configure virtual IP LIFs^].
