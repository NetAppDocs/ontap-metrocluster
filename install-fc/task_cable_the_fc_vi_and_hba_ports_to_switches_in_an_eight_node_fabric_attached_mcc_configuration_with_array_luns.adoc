...
+
|===
5+| Configurations using FibreBridge 7500N or 7600N using both FC ports (FC1 and FC2)
5+| MetroCluster 1 or DR Group 1
.2+| Component .2+| Port 2+| Brocade switch models 6505, 6510, 6520, 7810, 7840, G610, G620, G620-1, G630, G630-1, and DCX 8510-8| 2+ Brocade switch G720
