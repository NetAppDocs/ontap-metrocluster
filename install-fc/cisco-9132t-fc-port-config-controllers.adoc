...
The following table shows the supported Cisco 9132T controller configurations for MetroCluster 1 or DR group 1. You should be aware of the following when using this configuration table:
