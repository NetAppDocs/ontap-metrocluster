...
. Configure intercluster LIFs using the procedure in link:concept_configure_the_mcc_software_in_ontap.md#[Configuring intercluster LIFs].
. Create a cluster peer relationship using the procedure in link:concept_configure_the_mcc_software_in_ontap.md#[Creating a cluster peer relationship].
