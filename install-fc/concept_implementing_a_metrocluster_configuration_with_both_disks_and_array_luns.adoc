---
permalink: install-fc/concept_implementing_a_metrocluster_configuration_with_both_disks_and_array_luns.html
sidebar: sidebar
keywords: 
...
xref:reference_example_of_a_two_node_fabric_attached_metrocluster_configuration_with_disks_and_array_luns.adoc[Example of a two-node fabric-attached MetroCluster configuration with disks and array LUNs]

xref:concept_example_of_a_four_node_metrocluster_configuration_with_disks_and_array_luns.adoc[Example of a four-node MetroCluster configuration with disks and array LUNs]
