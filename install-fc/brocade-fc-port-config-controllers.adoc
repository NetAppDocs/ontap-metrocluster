...
The following table shows the supported controller configurations in MetroCluster 1 or DR group 1 for Brocade switches.
...
The following table shows the supported controller configurations in MetroCluster 2 or DR group 2 for Brocade switches.
...
The following table shows the supported controller configurations in MetroCluster 3 or DR group 3 for Brocade switches.
...
The following table shows the supported controller configurations in MetroCluster 4 or DR group 4 for Brocade switches.
