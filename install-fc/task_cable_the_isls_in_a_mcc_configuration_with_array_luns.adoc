...
|===
| Switch mode l| ISL port | Switch port
...
3+|* The Cisco 9250i switch uses the FCIP ports for the ISL. There are certain limitations and procedures for using the FCIP ports.
