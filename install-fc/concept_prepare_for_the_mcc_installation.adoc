...
xref:task_configure_the_mcc_hardware_components_fabric.adoc[Configuring the MetroCluster hardware components in systems with native disk shelves]
...
No
a|
Yesxref:task_cable_the_isl_between_the_mcc_sites_fabric_config.adoc[Cabling the ISLs between MetroCluster sites]
