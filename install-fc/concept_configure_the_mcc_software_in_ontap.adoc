...
Beginning in Fabric OS 9.0.1, SNMPv2 is not supported for health monitoring on Brocade switches and you must use SNMPv3. 
...
+
The command you use depends on whether you are using SNMPv2 or SNMP v3.
+
[role="tabbed-block"]
====
.If you are using SNMPv2
--
Run the command: `storage switch add -address ipaddress`
--
.If you are using SNMPv3
--
Run the command: `<need command here>`
--
==== 
+
