...
Beginning in Fabric OS 9.0.1, SNMPv2 is not supported for health monitoring on Brocade switches, you must use SNMPv3. If you are using SNMPv3, you must configure SNMPv3 in ONTAP before proceeding to the following section. For more details, see <<Configuring SNMPv3 in a MetroCluster configuration>>.
