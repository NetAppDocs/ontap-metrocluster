...
For more general information about setting up ONTAP, see the link:https://docs.netapp.com/us-en/ontap/task_configure_ontap.html[Set up ONTAP]
...
See link:[Disk and aggregate management].
