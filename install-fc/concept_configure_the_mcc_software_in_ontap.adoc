...
For more general information about setting up ONTAP, see the https://docs.netapp.com/ontap-9/topic/com.netapp.doc.dot-cm-ssg/home.html[Software Setup Guide]
...
. Use the procedures for negotiated switchover, healing, and switchback that are mentioned in the https://docs.netapp.com/us-en/ontap-metrocluster/manage/index.html[MetroCluster Management and Disaster Recovery Guide].
