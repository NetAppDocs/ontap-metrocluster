...
[CAUTION]
====
* In FOS 10.x, Brocade supports only SHA-512 for SNMP authentication. ONTAP currently does not support SHA-512, with support limited to SHA2‑256.
* If your MetroCluster FC switches are running FOS 10.x, you cannot configure SNMP.
====
