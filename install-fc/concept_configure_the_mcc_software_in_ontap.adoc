...
link:concept_prepare_for_the_mcc_installation.adoc[Considerations when using dedicated ports]
...
link:concept_prepare_for_the_mcc_installation.adoc[Considerations when sharing data ports]
