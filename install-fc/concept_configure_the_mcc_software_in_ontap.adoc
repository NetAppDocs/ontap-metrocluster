...
For more general information about setting up ONTAP, see the https://docs.netapp.com/ontap-9/topic/com.netapp.doc.dot-cm-ssg/home.html[Setup ONTAP]
...
.In ONTAP 9.6 and later
--
Ron the command: `network interface show -service-policy default-intercluster -failover`
--
.In ONTAP 9.5 and earlier
--
...
See https://docs.netapp.com/ontap-9/topic/com.netapp.doc.dot-cm-psmg/home.html[Disk and aggregate management].
...
NOTE: Changing the configuration requires rebooting the controller.
