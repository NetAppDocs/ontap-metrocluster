...
NOTE: If you want to use a single mirrored data aggregate, then see link:concept_configure_the_mcc_software_in_ontap.adocSTEP_429E7F7532ED4B468B67B9B22968D686[Step 1 in "Configure the MetroCluster software in ONTAP"] for instructions.
