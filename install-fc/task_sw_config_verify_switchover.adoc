...
+
https://docs.netapp.com/us-en/ontap/system-admin/index.html[Cluster Management with the CLI^] contains additional information under the section https://docs.netapp.com/us-en/ontap/system-admin/config-backup-file-concept.html[Managing configuration backups^].

.Related information

https://docs.netapp.com/us-en/ontap/cluster-admin/index.html[Cluster administration^]

// BURT 1448684, 20 JAAN 2022
