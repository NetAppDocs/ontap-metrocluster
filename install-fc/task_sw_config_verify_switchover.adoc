...
a| Mail hosts
a| IP addresses or names
a|

.2+a| Transport protocol
a| HTTP, HTTPS, or SMTP
a|
...
h| Disk shelf (sample_shelf_name)... h| At site... h| Belongs to... h| And is assigned to that node's...
...
NOTE: If you want to use a single mirrored data aggregate, then see Step 1 in link:concept_configure_the_mcc_software_in_ontap.html[Configure the MetroCluster software in ONTAP] for instructions.
...
link:https://docs.netapp.com/us-en/ontap/high-availability/index.html[HA pair management^]
...
. Use the procedures for negotiated switchover, healing, and switchback in https://docs.netapp.com/us-en/ontap-metrocluster/manage/index.html[MetroCluster management and disaster recovery]
...
+
https://docs.netapp.com/us-en/ontap/system-admin/config-backup-file-concept.html[Managing configuration backups^] contains additional information.
