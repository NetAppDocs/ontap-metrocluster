...
* The maximum number of drives, both HDD and SSD, is 240. 
...
* DS460 shelves should not be on the same SAS port as other shelf types (for example, DS212 or DS224 shelves).
