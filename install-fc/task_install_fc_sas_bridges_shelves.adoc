...
---
= Install FC-to-SAS bridges and SAS disk shelves in a MetroCluster FC configuration
:icons: font
:imagesdir: ../media/
...
image::../media/workflow_bridge_installation_and_configuration.gif["Workflow FC to SAS bridge installation and configuration"]
