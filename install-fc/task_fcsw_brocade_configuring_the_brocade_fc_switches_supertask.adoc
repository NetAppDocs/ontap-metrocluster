---
permalink: install-fc/task_fcsw_brocade_configuring_the_brocade_fc_switches_supertask.html
sidebar: sidebar
...
+
link:concept_preparing_for_the_metrocluster_installation.md#[Considerations for using TDM/WDM equipment with fabric-attached MetroCluster configurations]
...
+
link:concept_configuring_the_metrocluster_software_in_ontap.md#[Configuring in-order delivery or out-of-order delivery of frames on ONTAP software]
...
link:concept_preparing_for_the_metrocluster_installation.md#[Requirements for using a Brocade DCX 8510-8 switch]
...
----
. Repeat link:task_fcsw_brocade_configuring_the_brocade_fc_switches_supertask.md#STEP_4A4B1D7D68DC41CB903863FAB6081A4E[Step 1] through link:task_fcsw_brocade_configuring_the_brocade_fc_switches_supertask.md#STEP_1EB4B19CF25E48D88A972E4CBAA6EA62[Step 10] for the second FC switch fabric.
