...
* You must provide any additional settings not documented in this procedure if they are required on the Inter-Switch Links (ISL) because of your specific DWDM configuration.
