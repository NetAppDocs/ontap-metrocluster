...
The following table shows the maximum supported configuration in MetroCluster 1 or DR group 1. 
...
The following table shows the maximum supported configuration in MetroCluster 2 or DR group 2. 
