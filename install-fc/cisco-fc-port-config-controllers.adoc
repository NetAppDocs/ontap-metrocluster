...
The following table shows the supported controller configurations in MetroCluster 1 or DR group 1 for Cisco switches (excluding 9132T). 
...
The following table shows the supported controller configurations in MetroCluster 2 or DR group 2 for Cisco switches (excluding 9132T).
