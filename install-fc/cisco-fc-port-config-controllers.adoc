...
sidebar: sidebar
keywords:  ONTAP, FC, Cisco, metrocluster, switch, cabling, controllers, port, assignments
...
The following table shows the supported port assignments for MetroCluster 1 or DR group 1 when cabling Cisco 9124V, 9148S, 9148V, 9250i, or 9396S FC switches to your controllers.
...
The following table shows the supported port assignments for MetroCluster 2 or DR group 2 when cabling Cisco 9124V, 9148S, 9148V, 9250i, or 9396S FC switches to your controllers.
