...
This task requires file transfer software, such as FTP, Trivial File Transfer Protocol (TFTP), SFTP, HTTP, or Secure Copy Protocol (SCP) to copy the files to the switches.
