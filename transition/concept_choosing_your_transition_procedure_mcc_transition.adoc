...
*Note:* You can nondisruptively transition from a four-node MetroCluster FC configuration to a four-node MetroCluster IP configuration or from an eight-node MetroCluster FC configuration to an eight-node MetroCluster IP configuration. 
a| Two node
a| Disruptive
