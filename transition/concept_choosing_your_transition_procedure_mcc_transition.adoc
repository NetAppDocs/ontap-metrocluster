...
* The transition procedures all require ONTAP 9.8 or later unless stated otherwise in the notes or as required by an individual platform. Refer to the link:https://hwu.netapp.com[Hardware universe^] for supported ONTAP versions for the platform. 
