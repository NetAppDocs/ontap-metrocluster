...
* Note 1: You must have a 40GbE interface for the local cluster interfaces on the FC nodes.

* Note 2: You must have a 100GbE interface for the local cluster interfaces on the FC nodes.
