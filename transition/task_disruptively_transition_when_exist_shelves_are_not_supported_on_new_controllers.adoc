...
image::../media/workflow_2n_transition_old_shelves_not_supported.png["Workflow for transition when old shelves are not supported"]
...
image::../media/transition_2n_unsupported_old_new_shelves_to_old_controllers.png["Cabling new shelves to old controllers during transition"]
