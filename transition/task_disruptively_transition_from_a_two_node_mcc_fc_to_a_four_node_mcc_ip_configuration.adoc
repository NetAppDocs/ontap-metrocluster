...
+
See xref:concept_requirements_for_fc_to_ip_transition_2n_mcc_transition.adoc[Drive shelf reuse and drive requirements for disruptive FC-to-IP transition].
