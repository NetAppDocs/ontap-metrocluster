...
+
See the information gathered in link:task_connecting_the_metrocluster_ip_controller_modules_2n_mcc_transition_supertask.md#[Creating the network configuration].
