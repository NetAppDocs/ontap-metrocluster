...
+
image::../media/transition_2n_4_new_ip_nodes_on_the_shelves.png["Transition with four new IP nodes on existing shelves"]
+
...
image::../media/workflow_2n_transition_bsaic.png["Workflow for two-node transition"]
