...
+
link:../install-ip/concept_considerations_mediator.adoc
+
...
+
link:../tiebreaker/concept_overview_of_the_tiebreaker_software.html[Tiebreaker Software Installation and Configuration Guide]
