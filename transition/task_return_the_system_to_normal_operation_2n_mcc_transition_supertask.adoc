...
+
link:../install-ip/concept_prepare_for_the_mcc_installation.html#considerations-for-using-ontap-mediator-or-metrocluster-tiebreaker[Considerations for using ONTAP Mediator or MetroCluster Tiebreaker]
+
link:../install-ip/concept_configure_the_ontap_mediator_for_unplanned_automatic_switchover.html[Configuring the ONTAP Mediator service for unplanned automatic switchover]
+
link:../tiebreaker/index.html[Tiebreaker Software Installation and Configuration Guide]
