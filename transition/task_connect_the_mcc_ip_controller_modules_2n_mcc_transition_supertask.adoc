...
. If the root volume is encrypted, use the procedure in xref:task_connect_the_mcc_ip_controller_modules_2n_mcc_transition_supertask.adoc[Recovering key management if the root volume is encrypted].
