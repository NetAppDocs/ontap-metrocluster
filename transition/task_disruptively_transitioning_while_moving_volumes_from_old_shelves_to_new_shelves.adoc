...
+
Perform the steps in the section link:task_transitioning_the_metrocluster_fc_nodes_2n_mcc_transition_supertask.md#[Gathering information from the existing controller modules before the transition]
...
+
Perform the steps in the section link:task_transitioning_the_metrocluster_fc_nodes_2n_mcc_transition_supertask.md#[Transitioning the MetroCluster FC nodes].

. Connect the new MetroCluster IP nodes.
+
Perform the steps in the section link:task_connecting_the_metrocluster_ip_controller_modules_2n_mcc_transition_supertask.md#[Connecting the MetroCluster IP controller modules].

. Configure the new MetroCluster IP nodes and complete transition.
+
Perform the steps in the section link:task_configuring_the_new_nodes_and_completing_transition.md#[Configuring the new nodes and completing transition].
...
+
Perform the steps in link:task_returning_the_system_to_normal_operation_2n_mcc_transition_supertask.md#[Returning the system to normal operation]
