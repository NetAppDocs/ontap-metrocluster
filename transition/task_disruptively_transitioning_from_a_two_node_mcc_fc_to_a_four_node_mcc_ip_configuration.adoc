...
+
See xref:concept_drive_shelf_reuse_and_spare_drive_requirements_for_disruptive_fc_to_ip_transition_2n_mcc_transition.adoc[Drive shelf reuse and drive requirements for disruptive FC-to-IP transition].
