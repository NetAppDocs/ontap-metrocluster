...
+
Perform all the steps in the section link:task_transitioning_the_metrocluster_fc_nodes_2n_mcc_transition_supertask.md#[Transitioning the MetroCluster FC nodes].

. Add the new MetroCluster IP nodes.
+
Perform all the steps in the section link:task_connecting_the_metrocluster_ip_controller_modules_2n_mcc_transition_supertask.md#[Connecting the MetroCluster IP controller modules].

. Complete the transition and initial configuration of the new MetroCluster IP nodes.
+
Perform all the steps in the section link:task_configuring_the_new_nodes_and_completing_transition.md#[Configuring the new nodes and completing transition].
