---
permalink: transition/task_transitioning_shutting_down_and_removing_the_mcc_fc_nodes.html
sidebar: sidebar
keywords: 
summary: ''
---
...
+
You must move the LIFs identified in step 1 of xref:task_mapping_ports_from_the_old_node_to_the_new_node_2n_mcc_transition.adoc[Mapping ports from the MetroCluster FC nodes to the MetroCluster IP nodes].
