---
permalink: transition/task_transitioning_from_mcc_fc_to_mcc_ip_configurations.html
sidebar: sidebar
keywords: 
summary: ''
---
...
If you are using existing switches, proceed to link:task_transitioning_from_mcc_fc_to_mcc_ip_configurations.md#[Moving the local cluster connections].
...
+
Use the ports described in link:task_transitioning_from_mcc_fc_to_mcc_ip_configurations.md#[Moving the cluster connections on the MetroCluster FC nodes].
