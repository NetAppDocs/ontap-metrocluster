...
+
You must move the LIFs identified in step 1 of xref:concept_requirements_for_fc_to_ip_transition_2n_mcc_transition.adoc[Mapping ports from the MetroCluster FC nodes to the MetroCluster IP nodes].
