...
. Remove ATTO bridge health monitoring configuration.
+
link:../maintain/task_modify_switch_or_bridge_ip_address_for_health_monitoring.html[Modify a switch or ATTO bridge IP address for health monitoring]
