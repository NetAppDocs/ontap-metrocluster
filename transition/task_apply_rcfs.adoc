...
+
Follow the steps in the section for your switch vendor from the link:../install-ip/using_rcf_generator[MetroCluster IP Installation and Configuration Guide]

 ** link:../install-ip/task_switch_config_broadcom[Resetting the Broadcom IP switch to factory defaults]
 ** link:../install-ip/task_switch_config_cisco.html#resetting-the-cisco-ip-switch-to-factory-defaults[Resetting the Cisco IP switch to factory defaults]
 ...
 ** link:../install-ip/task_switch_config_broadcom[Downloading and installing the Broadcom IP RCF files]
 ** link:../install-ip/task_switch_config_cisco[Downloading and installing the Cisco IP RCF files]
