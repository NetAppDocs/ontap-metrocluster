...
NOTE: If you are performing an four-node FC to eight-node IP transition, you can apply the four-node FC to eight-node IP RCF before you add the second DR group. You do not have to apply the four-node FC to four-node IP RCF first.
