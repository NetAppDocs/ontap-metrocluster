...
Beginning with ONTAP 9.13.1, this procedure is supported in MetroCluster IP configurations using a shared switch for MetroCluster IP and Ethernet attached storage. 
