...
Before you start this procedure, review the information in the following table carefully. This table applies to the platform models in the IP configuration you are transitioning to. If your existing platform is listed in the first column, and the platform you want to add to the configuration is listed in the second column, you must carefully read the public report located in the third column.
