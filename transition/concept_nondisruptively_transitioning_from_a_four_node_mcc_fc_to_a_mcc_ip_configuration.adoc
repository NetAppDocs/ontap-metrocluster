...
When you are applying the RCF as part of this procedure, you can apply the four-node FC to eight-node IP RCF before you add the second DR group. You do not have to apply the four-node FC to four-node IP RCF first.
...
At any time during the transition, the number of nodes in the MetroCluster configuration does not exceed twelve.
|===
