...
a| Requires adding one MetroCluster IP DR group. After you add the first MetroCluster IP DR group, you need to check the overall health of the cluster, move data to the newly added DR group, and unjoin the empty MetroCluster FC DR group. You then add the second MetroCluster IP DR group and continue the transition.  
