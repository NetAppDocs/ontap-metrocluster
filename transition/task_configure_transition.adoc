...
+
NOTE: If you are using the Onboard Key Manager, review link:https://docs.netapp.com/us-en/ontap/encryption-at-rest/enable-onboard-key-management-new-nodes-concept.html[enable onboard key management in newly added nodes] before you add a node to the cluster. 
+
