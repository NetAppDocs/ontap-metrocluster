...
+
link:task_replace_hardware_and_boot_new_controllers.md#[Determining the system IDs and VLAN IDs of the old controller modules]
...
Proceed to link:task_prepare_for_switchback_in_a_mcc_ip_configuration_supertask.md#[Preparing for switchback in a MetroCluster IP configuration].
