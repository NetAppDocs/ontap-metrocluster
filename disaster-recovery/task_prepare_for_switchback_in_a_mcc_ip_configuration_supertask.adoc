...
** You need the gateway address if you are using link:../install-ip/concept_considerations_layer_3.adoc.
+
...
** If the configuration is not using link:../install-ip/concept_considerations_layer_3.adoc, the value for _gateway-IP-address_ is *0* (zero).
+
