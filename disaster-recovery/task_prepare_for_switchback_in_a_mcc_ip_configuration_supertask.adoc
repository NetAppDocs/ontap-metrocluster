...
* If the configuration is not using link:../install-ip/concept_prepare_for_the_mcc_installation.html#considerations-for-layer-3-wide-area-networks[Layer 3 wide-area networks], the value for 'gateway-IP-address' is *0* (zero).
+
