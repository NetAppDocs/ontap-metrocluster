...
The old and new system IDs were identified in link:../disaster-recovery/task_replace_hardware_and_boot_new_controllers.adocl#determining-the-system-ids-of-the-replacement-controller-modules[Determining the new System IDs of the replacement controller modules].
