...
The old and new system IDs were identified in link:task_replace_hardware_and_boot_new_controllers.html#Determining-the-system-IDs-of-the-replacement-controller-modules[Determining the system IDs of the replacement controller modules].
