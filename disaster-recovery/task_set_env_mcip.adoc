...
+
** You need to determine VLAN ID if the platform models support VLAN IDs (see the <<vlan_id_supported_platfoms,list above>>) and if you are not using the default VLAN IDs.
