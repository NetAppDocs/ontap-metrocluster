...
.All other systems
--
The following output shows the IP addresses for a configuration with AFF A700 and FAS9000 systems with the MetroCluster IP interfaces on ports e5a and e5b. The output can vary depending on platform type. For example, on AFF A70, AFF A90, and AFF A1K systems. 
