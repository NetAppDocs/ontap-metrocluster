...
. Verify if the original systems were configured for end-to-end encryption:
+
...
+
----
1 mcc-ip-a400-01-a1a2-siteA mcc-ip-a400-01-a1 true
1 mcc-ip-a400-01-a1a2-siteA mcc-ip-a400-01-a2 true
1 mcc-ip-a400-01-b1b2-siteB mcc-ip-a400-01-b1 true
1 mcc-ip-a400-01-b1b2-siteB mcc-ip-a400-01-b2 true
4 entries were displayed.
----
