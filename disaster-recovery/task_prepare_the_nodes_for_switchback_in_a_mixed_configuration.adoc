...
. Proceed through the remaining tasks of the recovery process starting with link:task_complete_recovery.html#reestablishing-object-stores-for-fabricpool-configurations[Reestablishing object stores for FabricPool configurations].
