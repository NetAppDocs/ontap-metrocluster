...
If this occurs, repeat <<step2>> to boot the system to the ONTAP prompt. You will then need to perform a root recovery.

include::../_include/reset_the_root_recovery.adoc[] 
