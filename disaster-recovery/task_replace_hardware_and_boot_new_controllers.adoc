...
* link:../install-fc/task_fmc_mcc_transition_cable_the_new_mcc_controllers_to_the_exist_fc_fabrics.html[MetroCluster fabric-attached configuration]
...
----
+
NOTE: End-to-end encryption is only supported on AFF A400 systems.
