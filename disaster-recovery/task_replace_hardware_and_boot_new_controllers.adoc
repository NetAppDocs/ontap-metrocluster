...
a| link:../install-ip/index.html[MetroCluster IP installation and configuration]
a|
Disk shelves
a|
...
. Verify that all components are cabled correctly according to the _MetroCluster Installation and Configuration Guide_ for your configuration.
