...
The old and new system IDs were identified in link:../disaster-recovery/task_replace_hardware_and_boot_new_controllers.html[Replace hardware and booting new controllers].
