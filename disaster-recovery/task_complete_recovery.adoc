...
* For more information about FabricPool configurations, see the link:https://docs.netapp.com/ontap-9/topic/com.netapp.doc.dot-cm-psmg/home.html[Disk and Aggregates Power Guide].

.Step

. Follow the procedure "Replacing a FabricPool mirror on a MetroCluster configuration" in the link:https://docs.netapp.com/ontap-9/topic/com.netapp.doc.dot-cm-psmg/home.html[Disk and Aggregates Power Guide].
