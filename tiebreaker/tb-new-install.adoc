...
. If you are performing a new installation, download the MetroCluster Tiebreaker 1.6 software.
+
...
. If you are performing an upgrade, verify the version of Tiebreaker you are running:
+
`version show`
