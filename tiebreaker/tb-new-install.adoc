...
[.lead]
You can install the Tiebreaker 1.6 software in MetroCluster configurations running <ONTAP version>. 
...
+
----
[root@mcctb ~]# sh MetroClusterTiebreakerInstall-1.6
----
+
Respond to the prompts as shown in bold in the following example output: 
+
[subs="quotes"]
----
...
. Confirm that you are currently running the Tiebreaker 1.4 software:
+
----
NetApp MetroCluster Tiebreaker :> version show
NetApp MetroCluster Tiebreaker 1.4: Sun Mar 13 09:59:02 IST 2022
NetApp MetroCluster Tiebreaker :> exit
----
. Run the following command from the root directory to upgrade the software:
+
----
[root@mcctb mcctb1.6]# sh MetroClusterTiebreakerInstall-1.6
----
+
Respond to the prompts as shown in bold in the following example output:
+
...
[root@mcctb ~]# netapp-metrocluster-tiebreaker-software-cli
NetApp MetroCluster Tiebreaker :> version show
NetApp MetroCluster Tiebreaker 1.6: Thu Nov 16 01:12:10 EST 2023
----
--
====