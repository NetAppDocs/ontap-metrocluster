...
+
NOTE: When prompted during the installation, create the the non-root user and add the account to the mcctbgrp group.  
+
----
...
sh MetroClusterTiebreakerInstall-1.6
+
NOTE: When prompted during the upgrade, create the the non-root user and add the account to the `mcctbgrp` group. 
+
