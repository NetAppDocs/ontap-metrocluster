...
NOTE: 
TLS is disabled in the configuration file provided in the following example and the file is unsecure. However, the Vault server is running on the local host, and therefore there is no security risk.
+
----
