...
You must install JDK on your host system before installing or upgrading the Tiebreaker software. For systems running Tiebreaker 1.5, run OpenJDK 17, 18, or 19.
...
`java -version`
+
For a successful installation, the following output is displayed:
+
----
