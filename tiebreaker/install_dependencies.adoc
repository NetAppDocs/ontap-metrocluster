...
----
+
IMPORTANT: You *must* record and store the key IDs and initial root token information in a secure place. You will need to use the key IDs and root tokens later in the procedure. 
