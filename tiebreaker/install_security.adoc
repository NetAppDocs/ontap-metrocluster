...
+
* During installation, you should create a group named "mcctbgrp". The host root user and the user created during the installation must be members. Only members of this group can fully administer the Tiebreaker software.
+
