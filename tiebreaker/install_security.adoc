...
Refer to the link:https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/[Red Hat Enterprise Linux 8 documentation^] for more information.
