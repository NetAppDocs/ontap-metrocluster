...
[.lead]
Perform a new installation or upgrade to Tiebreaker 1.6 or 1.6P1 on your host Linux operating system to monitor MetroCluster configurations. 
...
. Download the MetroCluster Tiebreaker 1.6 or 1.6P1 software.
+
...
.Install Tiebreaker 1.6 or 1.6P1
--
Use the following steps for a new installation of Tiebreaker 1.6 or 1.6P1. 

.Steps

. At the `[root@mcctb ~] #` prompt, begin the installation:
+
To install Tiebreaker 1.6P1, run:
+
[source,cli]
sh MetroClusterTiebreakerInstall-1.6P1
+
To install Tiebreaker 1.6, run:
+
[source,cli]
sh MetroClusterTiebreakerInstall-1.6
+
The following example output shows successful installation of Tiebreaker 1.6:
+
.Show example
[%collapsible]
=====
...
----
--
.Upgrade from Tiebreaker 1.6 to 1.6P1
--
...
--
.Upgrade from Tiebreaker 1.5 to 1.6 or 1.6P1
--
Use the following steps to upgrade the Tiebreaker 1.5 software version to Tiebreaker 1.6 or 1.6P1.

.Steps

. At the `[root@mcctb ~] #` prompt, upgrade the software:
+
To upgrade to Tiebreaker 1.6P1, run:
+
[source,cli]
sh MetroClusterTiebreakerInstall-1.6P1
+
To upgrade to Tiebreaker 1.6, run:
+
[source,cli]
sh MetroClusterTiebreakerInstall-1.6
+
The following example output shows successful upgrade to Tiebreaker 1.6:
+
.Show example
[%collapsible]
=====
...
Use the following steps to upgrade the Tiebreaker 1.4 software version to Tiebreaker 1.6 or 1.6P1.
