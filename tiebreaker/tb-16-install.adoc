...
NOTE: After you install Tiebreaker 1.6 or later, you need to link:../tiebreaker/concept_configuring_the_tiebreaker_software.html#import-certificates-tb17[import certificates] to enable seamless monitoring.
