...
NOTE: After upgrading to Tiebreaker 1.6P1 from 1.6, you must remove monitoring and re-add the MetroCluster configuration. 
...
--
.Upgrade from Tiebreaker 1.4 to 1.6P1
--
