...
summary: Perform a new installation or upgrade to Tiebreaker 1.4 on your local computer to monitor MetroCluster configurations. 
---
...
[lead]
Perform a new installation or upgrade to Tiebreaker 1.4 on your local computer to monitor MetroCluster configurations. 
