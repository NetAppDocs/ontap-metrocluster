...
You can disable observer mode for the Tiebreaker software to automatically initiate a switchover after it detects a site failure. In Tiebreaker 1.6 and later, automatic switchover should already be enabled when you add a MetroCluster configuration to Tiebreaker.
