...
NOTE: In Tiebreaker 1.6 and later, you can enable automatic switchover when you add a monitor using the `monitor add wizard` command. Refer to link:concept_configuring_the_tiebreaker_software.html#add-metrocluster-configurations[Add MetroCluster configurations].
