...
* You can only upgrade to Tiebreaker 1.7 from Tiebreaker 1.6P1. Refer to link:tiebreaker/tb-16-install.html[Install Tiebreaker 1.6 or 1.6P1] to install or upgrade to Tiebreaker 1.6P1.
...
NOTE: After you upgrade to Tiebreaker 1.7 from 1.6P1, you remove the existing monitors and re-add the MetroCluster configuration for monitoring.
