...
NOTE: After you install Tiebreaker 1.7, you need to link:../tiebreaker/concept_configuring_the_tiebreaker_software.html#import-certificates-tb17[import certificates] to enable seamless monitoring.
...
. If you are upgrading, check which version of Tiebreaker you are running:
+
...
NOTE: If your upgrade fails with an error due to missing certificates, refer to link:../tiebreaker/concept_configuring_the_tiebreaker_software.html#import-certificates-tb17[Import certificates]. After your certificates are imported, you can try to upgrade again. 
-- 
====

.What's next?

After you have successfully installed or upgraded the Tiebreaker software, refer to link:concept_configuring_the_tiebreaker_software.html[Configure the MetroCluster Tiebreaker software] to add MetroCluster configurations and import the required certificates. 
