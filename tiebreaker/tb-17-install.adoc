...
NOTE: If your upgrade fails with an error due to missing certificates, refer to link:../tiebreaker/concept_configuring_the_tiebreaker_software.html#import-certificates[Import certificates] to import your certificates from ONTAP. After your certificates are imported, you can try to upgrade again. 
-- 
====
