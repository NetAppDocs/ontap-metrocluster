...
After you have successfully installed or upgraded Tiebreaker, link:configure-tb-workflow.html[configure the MetroCluster Tiebreaker software] to add MetroCluster configurations and import the required certificates. 
