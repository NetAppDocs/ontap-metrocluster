...
After you have successfully installed or upgraded Tiebreaker, link:concept_configuring_the_tiebreaker_software.html[configure the MetroCluster Tiebreaker software] to add MetroCluster configurations and import the required certificates. 
