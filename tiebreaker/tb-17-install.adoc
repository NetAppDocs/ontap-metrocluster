...
NOTE: After you install Tiebreaker 1.7, you need to link:concept_configuring_the_tiebreaker_software.html#import-certificates-tb17[import certificates] to enable seamless monitoring.
