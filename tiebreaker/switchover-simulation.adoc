...
[.lead]
Beginning with Tiebreaker 1.7, you can simulate a switchover to test the MetroCluster Tiebreaker switchover functionality.

.About this task

* The switchover simulation CLI command is only supported in Tiebreaker 1.7 or later.
