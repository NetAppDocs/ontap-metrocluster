...
---
= Prepare to install or upgrade the Tiebreaker software
:icons: font
:imagesdir: ../media/
...
h| ONTAP Tiebreaker version h| Supported ONTAP versions h| Supported Linux versions h| Additional software

a| 1.5
a| ONTAP 9.2, 9.3, 9.4, 9.5, 9.6, 9.7, 9.8, 9.9.1, 9.10.1, 9.11.1, or 9.12.1
a|
