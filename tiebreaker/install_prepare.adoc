...
a| None. OpenJDK 19.0.2 is bundled with the installation.
...
* If you are installing or upgrading to Tiebreaker 1.5 or later, link:install_security.html[Secure the Tiebreaker host and database installation].
* If you are installing or upgrading to Tiebreaker 1.4, link:install-dependencies-14.html[Install MetroCluster Tiebreaker 1.4 dependencies].
// 2024 Sep 12, ONTAPDOC-2244
// 2024 Apr 23, ONTAPDOC-1752, ONTAPDOC-1753
// 2024 Mar 13, ONTAPDOC-1687
// 2026 Sep 10, ONTAPDOC-4728
