...
[.lead]
Learn about the new ONTAP MetroCluster features and new and enhanced ONTAP features that improve the capabilities, manageability, and performance of MetroCluster configurations. 

== MetroCluster-specific features

The following table lists the new MetroCluster-specific features for each ONTAP release. 
