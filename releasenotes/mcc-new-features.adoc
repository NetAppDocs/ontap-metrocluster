...
* In four-node MetroCluster IP configurations, the following FlexVol volume limits for AFF A400, AFF C400, ASA A400, ASA C400, AFF C80, AFF A70, and AFF A50 systems have increased. The increased limits are as follows:
