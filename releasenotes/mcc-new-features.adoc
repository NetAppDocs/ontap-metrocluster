...
a|
Upgrading an AFF A70 to an AFF A90 system or a FAS70 to a FAS90 system is supported using `system controller replace` commands in a MetroCluster IP configuration.
