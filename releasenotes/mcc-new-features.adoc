...
a|
In four-node MetroCluster IP configurations, the following volume limits for AFF A400, AFF A70, AFF A90, AFF A1K, FAS70, FAS90, AFF C80, AFF A20, AFF A30, AFF A50, AFF C30, and AFF C60 systems have increased:
