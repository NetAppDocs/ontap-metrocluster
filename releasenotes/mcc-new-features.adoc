...
* AFF C800, AFF A800, AFF A900, AFF A90, and AFF A1K systems have the following limit updates:
** FlexVol volume limits per node: 1250 
** SVM limits: 64 SVMs per cluster
** LIF count: 256 LIFs per cluster

* AFF A400, AFF C400, ASA A400, ASA C400, AFF C80, AFF A70, and AFF A50 systems have the following limit updates:
