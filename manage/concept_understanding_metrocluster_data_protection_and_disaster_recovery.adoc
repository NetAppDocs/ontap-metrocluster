---
permalink: manage/concept_understanding_metrocluster_data_protection_and_disaster_recovery.html
sidebar: sidebar
keywords: 
summary: ''
---
...
link:concept_understanding_metrocluster_data_protection_and_disaster_recovery.md#[Automatic unplanned switchover in MetroCluster FC configurations]
...
link:task_performing_switchover_for_tests_or_maintenance.md#[Performing switchover for tests or maintenance]
