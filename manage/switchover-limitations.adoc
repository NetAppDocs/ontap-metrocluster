...
The following operations are not recommended when the system is in switchover which means that you should only perform them under guidance from NetApp support: 
