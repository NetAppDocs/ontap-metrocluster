...
Use these links to get further information:
* link:../tiebreaker/index.html[Install and configure the MetroCluster Tiebreaker software]
* link:../install-ip/concept_configure_the_ontap_mediator_for_unplanned_automatic_switchover.html[Configure the ONTAP Mediator service for unplanned automatic switchover]
