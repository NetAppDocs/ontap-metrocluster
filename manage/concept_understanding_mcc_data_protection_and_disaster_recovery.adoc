...
+
link:https://docs.netapp.com/us-en/ontap/high-availability/index.html[High-availability pair management^] has more information about how to recover from site-wide controller failures that do not include controller failures, as well as failures that include of one or more controllers.
