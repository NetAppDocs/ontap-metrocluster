...
==  Supported number of disks and shelves on FibreBridge 7600N and 7500N bridges

The following tables show the number of disks and shelves that are supported behind a pair of FibreBridge 7600N and 7500N bridges.
...
Review the number of disks supported behind a pair of FibreBridge 7600N or 7500N bridges:
...
Review the number of shelves supported behind a pair of FibreBridge 7600N and 7500N bridges:
