...
.. Beginning with the logical first shelf in the stack, connect IOM A port 3 to the to the IOM A port 1 on the next shelf until each IOM A in the stack is connected.
