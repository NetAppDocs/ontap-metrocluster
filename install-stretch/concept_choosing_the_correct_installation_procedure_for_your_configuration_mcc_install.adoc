...
. link:task_configure_the_mcc_hardware_components_2_node_stretch_atto.md#[Cabling a two-node bridge-attached stretch MetroCluster configuration]
...
. link:task_configure_the_mcc_hardware_components_2_node_stretch_sas.md#[Cabling a two-node SAS-attached stretch MetroCluster configuration]
. link:concept_configuring_the_mcc_software_in_ontap.md#[Configuring the MetroCluster software in ONTAP]
