...
image::../media/workflow_hardware_installation_and_configuration_2_node_sas_attached.gif["Workflow hardware setup two node stretch SAS attached configuration"]
