...
[.lead]
== IP network informatin worksheet for Site A ==
...
For more general information about setting up ONTAP, see the link:https://docs.netapp.com/ontap-9/topic/com.netapp.doc.dot-cm-ssg/home.html[Software Setup Guide]
...
xref:concept_preparing_for_the_mcc_installation.adoc[Considerations when using dedicated ports]

xref:concept_preparing_for_the_mcc_installation.adoc[Considerations when sharing data ports]
...
* Drives and array LUNs are owned by a specific node; when you create an aggregate, all drives in that aggregate must be owned by the same node, which becomes the home node for that aggregate.
* Aggregate names should conform to the naming scheme you determined when you planned your MetroCluster configuration.
* The link:https://docs.netapp.com/ontap-9/topic/com.netapp.doc.dot-cm-psmg/home.html[Disks and Aggregates Power Guide] contains more information about mirroring aggregates.
...
+
NOTE: If you want to use a single mirrored data aggregate, then see xref:concept_configuring_the_mcc_software_in_ontap.adocSTEP_429E7F7532ED4B468B67B9B22968D686[step 1] for instructions.
...
. Use the procedures for negotiated switchover, healing, and switchback that are mentioned in the link:https://docs.netapp.com/us-en/ontap-metrocluster/manage/index.html[MetroCluster Management and Disaster Recovery Guide].
...
+
The link:https://docs.netapp.com/ontap-9/topic/com.netapp.doc.dot-cm-sag/home.html[System Administration Guide] contains additional information under the section _Managing configuration backups_.
