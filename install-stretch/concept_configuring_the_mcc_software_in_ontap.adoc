...
image::../media/workflow_high_level_node_and_cluster_configuration_software.gif["Workflow diagram for node and cluster configuration in ONTAP"]
...
cluster 1:*> Cluster peer show -instance
