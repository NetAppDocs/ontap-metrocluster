...
. Use the procedures for negotiated switchover, healing, and switchback that are mentioned in the link:https://docs.netapp.com/us-en/ontap-metrocluster/manage/index.html[Recover from a disaster].
