...
link:concept_preparing_for_the_mcc_installation.html[Considerations when using dedicated ports]

link:concept_preparing_for_the_mcc_installation.html[Considerations when sharing data ports]
...
. Use the procedures for negotiated switchover, healing, and switchback that are mentioned in the link:https:../manage/index.html[Recover from a disaster].
...
// Error clean-up task, 26 Jan 2022
