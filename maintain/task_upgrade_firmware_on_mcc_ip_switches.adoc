...
// Start snippet: link to section on a page in same repository
// 3 placeholders: Permalink file name, anchor name, and link text
link:/install-ip/task_install_and_cable_the_mcc_components.md#task_download_and_install_the_cisco_ip_switch_software[Downloading and installing the Cisco switch NX-OS software]
// End snippet
