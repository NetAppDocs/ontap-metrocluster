...
NOTE: For additional information about recovery from node failures, see the section "Choosing the correct recovery procedure" in the link:../disaster-recovery/index.html[Recover from a disaster].
