...
+
NOTE: You must update the switches in the following order Switch_A_1, Switch_B_1, Switch_A_2, Switch_B_2. After you have configured the switches in the first fabric (Switch_A_1, Switch_B_1), you must repeat the steps to move the cluster LIFs on the second fabric ( Switch_A_2, Switch_B_2). Refer to link:task_install_and_cable_the_mcc_components.html[Learn about configuring the MetroCluster IP switches].
