...
+
Follow the steps in the section _Configuring the IP switches_ in the link:https://docs.netapp.com/us-en/ontap-metrocluster/install-ip/using_rcf_generator.html[MetroCluster IP Installation and Configuration Guide.]
+
...
+
Cable the new switch first (including the ISLs) according to the steps in the _Cabling the IP switches_ section in the link:https://docs.netapp.com/us-en/ontap-metrocluster/install-ip/using_rcf_generator.html[MetroCluster IP Installation and Configuration Guide].
+
[NOTE]
====
