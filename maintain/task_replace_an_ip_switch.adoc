...
+
If you are reconfiguring a MetroCluster IP that does not connect NS224 shelves to the MetroCluster IP switches, use the appropriate guides to add or move the NS224 shelves:
+
