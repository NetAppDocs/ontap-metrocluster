...
CAUTION: If you replace a switch that uses 25G ports with a new switch that uses 100G ports (for example replacing a BES-53248 switch with a Cisco 9336C switch), additional steps might be required. Refer to link:https://kb.netapp.com/on-prem/ontap/mc/MC-KBs/100G_link_not_coming_online_during_MetroCluster_back-end_switch_replacement?caseId=2010523490[100G link not coming online during MetroCluster back-end switch replacement].
