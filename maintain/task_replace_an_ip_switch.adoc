...
You can create a cabling worksheet to help you perform this procedure. The following is an example worksheet for converting a MetroCluster IP configuration to a shared Storage configuration connecting two NS224 shelves using the existing switches.
