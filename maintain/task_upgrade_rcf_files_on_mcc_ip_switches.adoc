...
+
* link:../install-ip/task_switch_config_cisco.html#migrate-cluster-lifs-before-a-switch-or-rcf-upgrade[Migrate cluster LIFs before a Cisco switch or RCF upgrade]
* link:../install-ip/task_switch_config_broadcom.html#migrate-cluster-lifs-before-a-switch-or-rcf-upgrade[Migrate cluster LIFs before a Broadcom switch or RCF upgrade]
* link:../install-ip/install-ip/task_switch_config_nvidia.html#migrate-the-cluster-lifs-before-a-switch-or-rcf-upgrade[Migrate cluster LIFs before a NVIDIA switch or RCF upgrade]
