...
link:task_replace_a_sle_fc_to_sas_bridge.html#hot-swapping-a-fibrebridge-a-6500n-bridge-with-a-fibrebrdige-7600n-or-7500n-bridge[Hot-swapping a FibreBridge 6500N bridge with a FibreBridge 7600N or 7500N bridge]
