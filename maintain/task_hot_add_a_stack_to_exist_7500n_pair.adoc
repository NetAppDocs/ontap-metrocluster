...
---
= Hot-adding a stack of SAS disk shelves to an existing pair of FibreBridge 7500N or 7600N bridges
:icons: font
:imagesdir: ../media/

[.lead]
You can hot-add a stack of SAS disk shelves to an existing pair of FibreBridge 7500N or 7600N bridges that have available ports.
