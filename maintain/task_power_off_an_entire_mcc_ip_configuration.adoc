...
[.lead]
Power off the entire MetroCluster IP configuration and all of the equipment before starting maintenance or relocation.
...
. Verify the MetroCluster configuration from both sites.
...
----
+
NOTE: In a MetroCluster IP configuration, the AUSO Failure Domain is already set to 'auso-disabled' unless the configuration uses ONTAP Mediator.
