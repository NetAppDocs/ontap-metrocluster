...
Shelf removal
a|
link:task_hot_removing_storage_from_a_mcc_fc_configuration.md#[Hot-removing storage from a MetroCluster FC configuration]
...
Switch replacement
a|
xref:task_replacing_a_brocade_fc_switch_mcc.adoc[Replacing a Brocade FC switch (MetroCluster)]
...
Firmware upgrade
a|
xref:task_upgrading_or_downgrading_the_firmware_on_a_brocade_fc_switch_mcc.adoc[Updating firmware on a Brocade FC switch]

xref:task_upgrading_or_downgrading_the_firmware_on_a_cisco_fc_switch_mcc.adoc[Updating firmware on a Cisco FC switch]
