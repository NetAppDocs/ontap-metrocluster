...
Firmware upgrade
a|
link:maintain/task_upgrade_firmware_on_mcc_ip_switches.html[Upgrade firmware on MetroCluster IP switches]
...
RCF file upgrade
a|
link:maintain/task_upgrade_rcf_files_on_mcc_ip_switches.html[Upgrade RCF files on MetroCluster IP switches]

link:maintain/task_upgrade_rcf_files_on_cisco_ip_switches_with_cleanupfiles.html[Upgrade RCF files on Cisco IP switches using CleanUpFiles]
...
Rename a switch
a|
link:maintain/task_rename_a_cisco_ip_switch.html[Rename a Cisco IP switch]
|===
