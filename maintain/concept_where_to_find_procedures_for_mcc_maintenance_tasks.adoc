...
Review the information in link:enable-console-logging-before-maintenance.html[prepare for MetroCluster maintenance] before performing any maintenance procedures. You must enable console logging and remove ONTAP Mediator or Tiebreaker monitoring before you begin the maintenance procedures. 
