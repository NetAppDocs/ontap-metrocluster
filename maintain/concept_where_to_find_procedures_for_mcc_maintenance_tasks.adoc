...
NOTE: With the release of ONTAP 9.8, the MetroCluster upgrade and expansion procedures have moved to the link:../upgrade/index.html[MetroCluster Upgrade and Expansion Guide] and link:../transition/index.html[Transition from MetroCluster FC to MetroCluster IP].
...
a| link:../upgrade/index.html[MetroCluster® Upgrade and Expansion]

a|
Transition from FC to IP connectivity
a| link:../transition/index.html[Transition from MetroCluster FC to MetroCluster IP]
.5+a|
Drive shelf
a|
FC
...
link:task_fb_hot_add_shelf.html[Hot-adding a SAS disk shelf to a stack of SAS disk shelves]
