...
summary: 'You must know how to power off and power on a single site in a MetroCluster FC configuration for the purpose of site maintenance or to relocate a site to another location.'
---
...
image::power-on-off-data-center.gif["MetroCluster with cluster powered off for maintenance"]
