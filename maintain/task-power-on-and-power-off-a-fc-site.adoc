...
---
= Power off and power on a singe site in a MetroCluster FC configuration
:icons: font
:imagesdir: ../media/

[.lead]
If you need to perform site maintenance or relocate a MetroCluster site, you must know how to power off and power on the site. 
