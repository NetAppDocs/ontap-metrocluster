...
+
NOTE: You must update the switches in the following order: Switch_A_1, Switch_B_1, Switch_A_2, Switch_B_2. Or, you can update the switches Switch_A_1 and Switch_A_2 at the same time followed by switches Switch_B_1 and Switch_B_2.
