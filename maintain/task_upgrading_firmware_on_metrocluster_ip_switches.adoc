---
permalink: maintain/task_upgrading_firmware_on_metrocluster_ip_switches.html
sidebar: sidebar
keywords: 
summary: ''
---
...
+
NOTE: In the sections referenced, skip the step on downloading the reference configuration (RCF) files.
