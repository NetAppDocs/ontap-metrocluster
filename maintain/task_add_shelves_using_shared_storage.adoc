...
NOTE: If you have the correct RCF available, you can skip these next sections and go to <<config_macsec_encryption, Configuring MACsec encryption on Cisco 9336C switches>>.
...
== [[configure_macsec_encryption]] Configuring MACsec encryption on Cisco 9336C switches
