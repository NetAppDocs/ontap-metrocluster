...
+
NOTE: In this step, you are only completing the download portion of the instructions provided in the links. You need to follow the steps found in the link:task_fb_hot_add_a_disk_shelf_install_7500n.md#[Hot-adding a disk shelf] section for installing the disk shelf.
