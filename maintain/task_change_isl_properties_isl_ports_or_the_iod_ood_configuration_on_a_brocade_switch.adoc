...
|===
+
NOTE: When you make changes to ISL ports you might also need to update additional settings recommended by the WDM vendor. Refer to the WDM vendor documentation for guidance.
