...
You must power off a site and all of the equipment before site maintenance or relocation can begin. In the following example Cluster_A remains online and Cluster_B (disaster site) is powered off.
