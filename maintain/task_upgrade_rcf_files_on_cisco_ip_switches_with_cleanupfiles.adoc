...
* The Cisco 9336C-FX2 switch has two different switch storage type uses. The RCF file might refer to a use that is named differently. Use the following table to determine the correct Cisco 9336C-FX2 storage type for your configuration:
+
