...
* The Cisco 9336C-FX2 switch has two different switch storage type uses. The RCF file might refer to a use that is named differently. Use the following table to determine the correct switch storage type for your configuration:
+
[cols=3*,options="header"]
|===
| If you are connecting the following storage...
| Choose the following switch storage type...
