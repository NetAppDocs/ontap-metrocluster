...
* The Cisco 9336C-FX2 switch has two different switch storage types. The RCF might refer to a storage type that is named differently compared with other switches. Use the following table to determine the correct Cisco 9336C-FX2 storage type for your configuration:
+
