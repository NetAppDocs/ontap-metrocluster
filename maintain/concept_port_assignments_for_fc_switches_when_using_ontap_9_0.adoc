...
The following table shows bridge port usage when using FibreBridge 7500 or 7600 bridges:
...
The following table shows bridge port usage up to port 17 when using FibreBridge 7500 or 7600 bridges. Additional bridges can be cabled to ports 18 through 23.
...
The following table shows bridge port usage up to port 17 when using FibreBridge 7500 or 7600 bridges with Brocade 6505, 6510, and DCX 8510-8 switches. Additional bridges can be cabled to ports 18 through 23.
...
The following table shows bridge port usage up to port 23 when using FibreBridge 7500 or 7600 bridges when using Cisco 9148 or 9148S switches. 
...
The following table shows bridge port usage up to port 14 when using FibreBridge 7500 or 7600 bridges with Cisco 9148, 9148S, or 9250i switches. Additional bridges can be attached to ports 15 through 32 following the same pattern.
...
The following table shows bridge port usage up to port 14 when using FibreBridge 7500 or 7600 bridges with Cisco 9148, 9148S, and 9250i switches. Additional bridges can be attached to ports 15 through 32 following the same pattern.
