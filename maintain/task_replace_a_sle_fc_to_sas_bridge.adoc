...
Correct
a|
Repeat <<step18-verify-each-bridge,Step 19>> for each remaining bridge.
a|
Not correct
a|

 .. Check for loose SAS cables or correct the SAS cabling by repeating <<step17-reconnect-newbridge,Step 18>>.
 .. Repeat <<step18-verify-each-bridge,Step 19>>.
