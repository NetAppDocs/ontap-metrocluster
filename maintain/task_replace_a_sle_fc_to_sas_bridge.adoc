...
Correct
a|
Repeat Step link:task_replace_a_sle_fc_to_sas_bridge.md#STEP_524EBC3334F54467B771D9E2FD2B2DDA[task_replace_a_sle_fc_to_sas_bridge.md#STEP_524EBC3334F54467B771D9E2FD2B2DDA] for each remaining bridge.
a|
Not correct
a|

 .. Check for loose SAS cables or correct the SAS cabling by repeating Step link:task_replace_a_sle_fc_to_sas_bridge.md#STEP_CD84065D8F3B43F192919B0CD6FDC1A6[task_replace_a_sle_fc_to_sas_bridge.md#STEP_CD84065D8F3B43F192919B0CD6FDC1A6].
 .. Repeat Step link:task_replace_a_sle_fc_to_sas_bridge.md#STEP_524EBC3334F54467B771D9E2FD2B2DDA[task_replace_a_sle_fc_to_sas_bridge.md#STEP_524EBC3334F54467B771D9E2FD2B2DDA].
...
. Update the FibreBridge firmware on each bridge.
+
link:task_update_firmware_on_a_fibrebridge_bridge_parent_topic.md#[Updating firmware on FibreBridge 7600N or 7500N bridges on configurations running ONTAP 9.4 and later]
