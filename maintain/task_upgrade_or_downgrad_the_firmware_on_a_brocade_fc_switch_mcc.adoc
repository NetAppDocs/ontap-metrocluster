...
* If you upgrade your MetroCluster FC switches to FOS 10.x, SNMP monitoring visibility from ONTAP will be lost. This causes an increased risk when troubleshooting and loss of proactive alerting. You must carefully consider these limitations before you proceed to upgrade the switch firmware to Fabric OS 10.x or later. 
====
