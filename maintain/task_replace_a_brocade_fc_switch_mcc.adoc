...
+
`firmwareShow`
.. Configure the new switch as described in _MetroCluster Installation and Configuration_, but skipping the "`Configuring zoning on Brocade FC switches`" procedure.
+
