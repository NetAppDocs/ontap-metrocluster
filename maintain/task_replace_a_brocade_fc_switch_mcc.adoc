...
. To enable ISL encryption, refer to link:../install-fc/task_fcsw_brocade_configure_the_brocade_fc_switches_supertask.html#setting-isl-encryption-on-brocade-6510-or-g620-switches[Configure the Brocade FC switches manually].
+
