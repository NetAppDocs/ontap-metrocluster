...
+
Beginning in ONTAP 9.16.1, you can use credentials to update the bridge firmware if they are required by the network or server to download the firmware package. 
+
[role="tabbed-block"]
====
