...
== Remove internal drives from integrated systems

When you upgrade from a modular system that doesn't have internal drives to an integrated system with disks and controllers in the same chassis, you need to remove or unseat all internal drives from the integrated system until you have completed the upgrade.

NOTE: This only applies if you are upgrading from a modular system to an integrated system. 
...
--
AFF A400, AFF A900, AFF A700, AFF A1K, AFF C400, FAS9000, FAS9500, FAS70, FAS90 
--
.Examples of integrated systems
--
AFF A90, AFF A70, AFF C800, AFF A800, AFF A250, AFF C250, AFF A50, AFF A30, AFF C30, AFF C60 
--
====
