...
---
= Boot up the new MetroCluster IP controllers 
:icons: font
:imagesdir: ../media/

[.lead]
Reboot the controllers from the boot menu to update the controller flash image. Additional steps are required if encryption is configured.
