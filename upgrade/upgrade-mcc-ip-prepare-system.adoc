...
* The new RCF that you are upgrading to must use the VLANs 10, 20 or be in the range 101 to 4096. Do not change the VLAN for the local cluster unless it is required.  
====
...
a|
e0c and e0d are matching ports. You don't have to change the configuration, but after upgrade you can spread your cluster LIFs across the available cluster ports.
