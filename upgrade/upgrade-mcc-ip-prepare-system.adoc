...
. Obtain the admin SVM (cluster) UUID:
+
`vserver show -vserver <admin_svm> -fields uuid`
+
----
cluster_B::*> vserver show -vserver admin -fields uuid
vserver uuid
------- ------------------------------------
vs0     01c7fd82-2777-11f1-b68c-005056bb8b48
----
