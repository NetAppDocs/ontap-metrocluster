...
.. Obtain the primary key server port and address for the admin SVM (cluster) by running the following command:
+
...
* The primary key server addresses and ports for the admin SVM
