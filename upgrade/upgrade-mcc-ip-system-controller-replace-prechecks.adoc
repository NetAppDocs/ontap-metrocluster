...
+
CAUTION: If you are repeating this procedure after already replacing the controllers at site B, you must run `system controller replace start -nso true -skip-metrocluster-check true` instead.
+
