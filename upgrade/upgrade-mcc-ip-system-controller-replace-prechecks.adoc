...
+
If either of your old or new platform models are listed above, you *must* verify that the VLAN ID for the MetroCluster interfaces is 10, 20, or in the range of 101 to 4096. If the VLAN ID is not 10, 20, or in the range of 101 to 4096, you *must* update the switch RCFs before you upgrade controllers. 
+
[NOTE] 
====
