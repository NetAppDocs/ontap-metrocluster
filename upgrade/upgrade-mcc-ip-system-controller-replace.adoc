...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-2.png[Two]upgrade-mcc-ip-system-controller-replace-prepare-network-configuration.html[Upgrade controllers using "system controller replace" commands]
[role="quick-margin-para"]
