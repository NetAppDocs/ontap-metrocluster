...
[role="quick-margin-para"]
The automation operation initiates the switchover operations. After these operations complete, the operation pauses so you can rack and install the controllers, boot up the partner controllers, and reassign the root aggregate disks before booting up the new controllers.
