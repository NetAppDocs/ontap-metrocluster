...
.	Re-cable the existing FC-VI and storage connections on the fabric A switches (switch 1 and 3) as directed by the new RCF, refer to link:/install-fc/index.html[Fabric-attached installation and configuration] documentation for the AFF A900 cabling
+
