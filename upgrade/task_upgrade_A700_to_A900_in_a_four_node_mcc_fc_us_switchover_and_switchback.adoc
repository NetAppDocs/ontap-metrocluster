...
[NOTE] 
====
* If there are any add-on modules used as coredump devices on the AFF A700 non-volatile storage module in slot6, do not transfer those to the AFF A900 or FAS9500 NVS module. Do not transfer any parts from the AFF A700 module and NVS to the AFF A900 NVS and controller modules. 
* For FAS9000 to FAS9500 upgrades, only Flash Cache modules on the FAS9000 NVS module should be transferred to FAS9500 NVS module. Do not transfer any other parts from the FAS9000 module and NVS to the FAS9500 NVS and controller modules. 
====
