...
---
= Upgrade controllers from AFF A700 to AFF A900 or FAS9000 to FAS9500 in a MetroCluster FC configuration using switchover and switchback (ONTAP 9.10.1 and later)
:icons: font
:imagesdir: ../media/
