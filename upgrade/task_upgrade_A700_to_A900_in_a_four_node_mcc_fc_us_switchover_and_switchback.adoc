...
link:../tiebreaker/concept_configuring_the_tiebreaker_software.html#remove-metrocluster-configurations[Removing MetroCluster Configurations]
...
image::../media/mcc_upgrade_cluster_a_in_switchover_A900.png["Site_B inactive and ready for upgrade"]
...
. Use the steps in: link:../tiebreaker/concept_configuring_the_tiebreaker_software.html#add-mcc-config-tb[Adding MetroCluster configurations] in the _MetroCluster Tiebreaker Installation and Configuration_ section.

// 2025 Apr 24, ONTAPDOC-2651
// 2023 JULY 5, ONTAPDOC-1083
// 2023 May 05, GH issue 277
