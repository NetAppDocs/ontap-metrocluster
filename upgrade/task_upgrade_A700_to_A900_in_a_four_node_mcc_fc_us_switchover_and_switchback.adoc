...
.	After updating the RCF files on the fabric A switches (switch1 and switch3), all storage and FC-VI connections should come online. Check the FC-VI connections:
+
