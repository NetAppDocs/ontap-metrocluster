...
* When you upgrade from systems that have more slots or ports than the new system you are upgrading to, you need to verify that there are sufficient slots and ports on the new system. 
+
