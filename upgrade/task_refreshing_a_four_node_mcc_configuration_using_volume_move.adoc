---
permalink: upgrade/task_refreshing_a_four_node_mcc_configuration_using_volume_move.html
sidebar: sidebar
keywords: 
summary: ''
---
...
+
link:task_refreshing_a_four_node_mcc_configuration_using_volume_move.md#[Adding new nodes to the MetroCluster IP configuration]
+
...
* You must complete the initial steps in link:task_refreshing_a_four_node_mcc_configuration_using_volume_move.md#[Refreshing a four-node MetroCluster IP configuration (ONTAP 9.8 and later)].
+
After completing this procedure, return to link:task_refreshing_a_four_node_mcc_configuration_using_volume_move.md#[Refreshing a four-node MetroCluster IP configuration (ONTAP 9.8 and later)] to complete the refresh of the configuration.
...
4 entries were displayed.
----
. Complete the remaining steps in link:task_refreshing_a_four_node_mcc_configuration_using_volume_move.md#[Refreshing a four-node MetroCluster IP configuration (ONTAP 9.8 and later)].
+
