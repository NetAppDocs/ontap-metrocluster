...
[.lead]
Update the switch reference configuration files (RCF) for the new platforms and set the MetroCluster IP bootarg values on the controller modules. 
...
. Set the following bootargs at the `LOADER` prompt:
+
