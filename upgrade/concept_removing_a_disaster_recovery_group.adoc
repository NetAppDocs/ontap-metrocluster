...
. Prepare for the removal of the DR group, if you haven't already.
 ...
 .. Since load-sharing mirror volumes cannot be moved, recreate all load-sharing mirror volumes in another DR group and then delete the load-sharing mirror volumes in the DR group to be removed.
