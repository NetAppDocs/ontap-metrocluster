...
`disk show` 
+
All spare disks are displayed, including the Pool1 and pool1 spare disks owned by the node. The following example shows truncated output where 0n.4 disks are assigned to Pool1. The output will vary depending on your configuration.
+
----
...
0n.4P2       node_A1(537102267)    Pool1  S3N9NX0J500267NP003   node_A1(537102267)
0n.4P3       node_A1(537102267)    Pool1  S3N9NX0J500267NP002   node_A1(537102267)
----
...
+
In the following example, ownership of the partitioned disks are removed before the ownership of the container disk `0n.4` is removed:
+
----
