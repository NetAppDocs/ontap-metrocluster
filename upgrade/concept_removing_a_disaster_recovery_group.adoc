...
`disk show` 
+
All spare disks are displayed, including the Pool1 spare disks owned by the node. The following example shows truncated output where 0n.4 disks are assigned to Pool1. The output will vary depending on your configuration.
+
----
