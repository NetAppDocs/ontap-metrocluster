...
. Prepare to remove the DR group if you have not already.
 ...
 .. If the DR group to be removed contains load-sharing mirror volumes, re-create all load-sharing mirror volumes in another DR group and then delete them from in the DR group to be removed.
