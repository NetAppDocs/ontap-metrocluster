...
. Prepare for the removal of the DR group, if you haven't already.
 ...
 ... If the DR group to be removed contains load-sharing mirror volumes, you must create a new load-sharing mirror volume in another DR group. Load-sharing mirror volumes cannot be moved.
