...
`aggr status -s` 
+
All spare disks are displayed, including the pool0 and pool1 spare disks owned by the node. You should see output similar to the following:
+
----
0n.7         node_A1(538300171)    Pool1  S7J8NE0W600508        node_A1(538300171)
0n.7P1       node_A2(538299967)    Pool1  S7J8NE0W600508NP001   node_A2(538299967)
