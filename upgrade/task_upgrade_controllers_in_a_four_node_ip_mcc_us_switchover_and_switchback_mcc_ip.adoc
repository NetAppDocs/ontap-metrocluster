...
. At the `LOADER` prompt, set the following bootargs:
+
The steps you follow depends on your platform model.
+
[role="tabbed-block"]
====
...
----
setenv bootarg.mcc.port_a_ip_config local-IP-address,gateway-IP-address,HA-partner-IP-address,DR-partner-IP-address,DR-aux-partnerIP-address,vlan-id

setenv bootarg.mcc.port_b_ip_config local-IP-address,gateway-IP-address,HA-partner-IP-address,DR-partner-IP-address,DR-aux-partnerIP-address,vlan-id
----
...
....
setenv bootarg.mcc.port_a_ip_config 172.17.26.10,0,0,172.17.26.13,172.17.26.12,120

setenv bootarg.mcc.port_b_ip_config 172.17.27.10,0,0,172.17.27.13,172.17.27.12,130
....

The following example shows the commands for node_A_1 without a VLAN ID:

----
setenv bootarg.mcc.port_a_ip_config 172.17.26.10,0,0,172.17.26.13,172.17.26.12

setenv bootarg.mcc.port_b_ip_config 172.17.27.10,0,0,172.17.27.13,172.17.27.12
----
--
.All other systems
--
...
....
setenv bootarg.mcc.port_a_ip_config 172.17.26.10,0,172.17.26.11,172.17.26.13,172.17.26.12,120

setenv bootarg.mcc.port_b_ip_config 172.17.27.10,0,172.17.27.11,172.17.27.13,172.17.27.12,130
....

The following example shows the commands for node_A_1 without a VLAN ID:

----
setenv bootarg.mcc.port_a_ip_config 172.17.26.10,0,172.17.26.11,172.17.26.13,172.17.26.12

setenv bootarg.mcc.port_b_ip_config 172.17.27.10,0,172.17.27.11,172.17.27.13,172.17.27.12
----

--
====

. At the LOADER prompt for each of the surviving nodes, set the following bootargs with local_IP/mask:
+
The steps you follow depends on your platform model.
+
[role="tabbed-block"]
