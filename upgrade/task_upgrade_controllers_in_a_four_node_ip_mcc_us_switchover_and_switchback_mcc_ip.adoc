...
* If your system has end-to-end encryption enabled, link:../maintain/task-configure-encryption.html[Disable end-to-end encryption] before performing the upgrade. 
