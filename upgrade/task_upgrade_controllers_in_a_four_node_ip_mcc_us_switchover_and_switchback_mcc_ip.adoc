...
* If your system is configured with end-to-end encryption, link:../maintain/task-configure-encryption.html#disable-end-to-end-encryption[Disable end-to-end encryption] before performing the controller upgrade. 
...
If it is supported on your system, you can encrypt back-end traffic, such as NVlog and storage replication data, between the MetroCluster IP nodes. Refer to link:../maintain/task-configure-encryption.html[Configure end-to-end encryption] for more information.
