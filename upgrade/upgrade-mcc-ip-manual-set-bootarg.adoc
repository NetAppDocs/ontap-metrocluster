...
CAUTION: If your upgrade is affected, you *must* set a required bootarg on the existing system before performing the upgrade. If your upgrade isn't affected, you can skip this task and go directly to link:upgrade-mcc-ip-manual-set-bootarg.html[Prepare the system for upgrade].
