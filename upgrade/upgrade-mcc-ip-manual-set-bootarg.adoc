...
* You do *not* have to set a bootarg on the old controllers when you upgrade to a platform that is not listed above, or if your upgrade is one of the following combinations:
...
a| All other affected upgrades to AFF A70, AFF A90, AFF A1K, FAS70, FAS90, AFF C80, AFF A50, AFF A20, AFF A30, AFF C30, AFF C60, or FAS50 systems | `hw.cxgbe.toe_keepalive_disable`
|===
