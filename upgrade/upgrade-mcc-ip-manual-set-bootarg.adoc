...
NOTE: If your upgrade combination is affected, setting a bootarg on the old controllers is required for a successful upgrade. Review the information in this section carefully to check if your upgrade combination requires that you set a bootarg, and how to set the correct bootarg for your combination. 
