...
| For this upgrade...
| Set the bootarg...
| From AFF A250 to AFF A30 | `bootarg.siw.interop_enable`
| From AFF C250 to AFF C30 | `bootarg.siw.interop_enable`
| From AFF A150 to AFF A20 | `bootarg.siw.interop_enable`
| From AFF A220 to AFF A20 | `bootarg.siw.interop_enable`
