...
* You *must* set a bootarg on the old controllers before starting the upgrade if any of the following applies to your upgrade combination:

** You are upgrading to an AFF A90 system from any supported system other than AFF A70
** You are upgrading to a FAS90 system from any supported system other than FAS70
...
* You do *not* have to set a bootarg on the old controllers if any of the following applies to your upgrade combination: 
