...
a| All other upgrades to AFF A70, AFF A90, AFF A1K, FAS70, FAS90, AFF C80, AFF A50, AFF A20, AFF A30, AFF C30, AFF C60, or FAS50 systems

*Note:* You don't have to set any bootarg if your upgrade is from an AFF A70 to AFF A90 system or from a FAS70 or FAS90 system. | `hw.cxgbe.toe_keepalive_disable`
|===
