...
* Note 3: Upgrades of integrated systems with disks and controllers in the same chassis requires replacement of the controller modules.
...
* Note 5: Requires replacement of the controller modules and ONTAP 9.18.1GA or later.
...
image:../media/assisted-group-2-a70-a90-updated.png[Shows AFF and FAS upgrade combinations group 2]
--
====
