...
[role="quick-margin-para"]
Switchover the MetroCluster configuration to remove the configuration from the old controllers, prepare, and boot the new controllers at one site before performing a switchback.
