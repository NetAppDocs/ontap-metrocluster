---
permalink: upgrade/task_upgrading_controllers_in_a_four_node_fc_metrocluster_using_switchover_and_switchback_mcc_fc_4n_cu.html
sidebar: sidebar
keywords: 
summary: ''
---
...
* You will use the information gathered in link:task_upgrading_controllers_in_a_four_node_fc_metrocluster_using_switchover_and_switchback_mcc_fc_4n_cu.md#[Mapping ports from the old nodes to the new nodes].
...
The old system IDs were identified in link:task_upgrading_controllers_in_a_four_node_fc_metrocluster_using_switchover_and_switchback_mcc_fc_4n_cu.md#[Gathering information before the upgrade].
...
. Repeat the steps to upgrade the nodes on cluster_A, beginning with link:task_upgrading_controllers_in_a_four_node_fc_metrocluster_using_switchover_and_switchback_mcc_fc_4n_cu.md#[Preparing for the upgrade].
+
