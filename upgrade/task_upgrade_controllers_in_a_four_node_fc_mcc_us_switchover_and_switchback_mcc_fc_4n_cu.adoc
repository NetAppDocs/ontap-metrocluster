...
.. Issue the correct command for your configuration on cluster_A:
+
[role="tabbed-block"]
====
.For four- or eight-node FC configurations running ONTAP 9.8 or later
--
Run the command: `metrocluster switchover -controller-replacement true`
--
.For two-node FC configurations running ONTAP 9.3 and later
--
