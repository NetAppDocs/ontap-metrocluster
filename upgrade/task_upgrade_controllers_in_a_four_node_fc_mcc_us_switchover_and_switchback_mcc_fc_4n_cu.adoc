...
+
`boot_ontap menu`
. I. If the admin SVM of the MetroCluster system is configured with a key manager, select the correct boot menu option for your key management configuration.  
+
[role="tabbed-block"]
====
.ONTAP 9.8 and later
