...
* You will use the information gathered in xref:task_upgrade_controllers_in_a_four_node_fc_mcc_us_switchover_and_switchback_mcc_fc_4n_cu.adoc[Mapping ports from the old nodes to the new nodes].
...
The old system IDs were identified in xref:task_upgrade_controllers_in_a_four_node_fc_mcc_us_switchover_and_switchback_mcc_fc_4n_cu.adoc[Gathering information before the upgrade].
...
.Steps
. Repeat the steps to upgrade the nodes on cluster_A, beginning with xref:task_upgrade_controllers_in_a_four_node_fc_mcc_us_switchover_and_switchback_mcc_fc_4n_cu.adoc[Preparing for the upgrade].
+
