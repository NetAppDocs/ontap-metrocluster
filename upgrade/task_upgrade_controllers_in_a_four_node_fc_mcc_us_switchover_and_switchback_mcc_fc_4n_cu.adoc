...
+
`boot_ontap menu`
. If root encryption is used, depending on your OTANP version, issue the boot menu command or select the boot menu option for your key management configuration.
+
For ONTAP 9.7 or earlier, issue the boot menu command.
+
...
|===
+
For ONTAP 9.8 or later, select the boot menu option.
+
...
. If root encryption is used, depending on your ONATP version, issue the boot menu command or select the boot menu option again for your key management configuration.
+
For ONTAP 9.7 or earlier, issue the boot menu command.
+
|===
