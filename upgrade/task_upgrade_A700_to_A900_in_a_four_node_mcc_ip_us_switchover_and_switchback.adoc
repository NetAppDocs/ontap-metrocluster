...
---
= Upgrade controllers from AFF A700 to AFF A900 or FAS9000 to FAS9500 in a MetroCluster IP configuration using switchover and switchback (ONTAP 9.10.1 and later)
...
+
Operating the MetroCluster configuration with an AFF A700 and an AFF A900, or a FAS9000 or FAS9500 controller is not supported outside of this maintenance activity.
...
The MetroCluster IP configuration on an AFF A700 or FAS9000 does not use VLANs. The MetroCluster configuration on an AFF A900 or FAS9500 does use VLANs. As a result, you need to change the RCF file when upgrading from an AFF A700 or FAS9000 to an AFF A900 or FAS9500.
