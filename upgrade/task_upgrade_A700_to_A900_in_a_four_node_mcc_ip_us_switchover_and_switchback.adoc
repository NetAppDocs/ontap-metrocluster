...
---
= Upgrade controllers in the same chassis using switchover and switchback in a MetroCluster IP configuration  (ONTAP 9.10.1 or later)
...
This procedure supports the following upgrades: 

[cols=3*,options="header"]
|===
| Existing system
| New system
| Minimum ONTAP version
| AFF A700 | AFF A900 | ONTAP 9.10.1
| FAS9000 | FAS9500 | ONTAP 9.10.1P3
| <existing_platform> | AFF A70 | ONTAP 9.15.1
| <existing_platform> | AFF A90 | ONTAP 9.15.1
|
|===
...
=== Clear the slots on the controller
...
== Remove the controller module and NVS
...
== Install the NVS and controller modules

You must install the NVS and controller module that you received in the upgrade kit on both nodes at site_B. Do not move the coredump device from the AFF A700 or FAS9000 NVS module to the AFF A900 or FAS9500 NVS module.
