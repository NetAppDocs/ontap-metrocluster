...
+
* link:../install-ip/task_switch_config_broadcom.html#reset-the-broadcom-ip-switch-to-factory-defaults[Reset the Broadcom IP switch to factory defaults] 
* link:../install-ip/task_switch_config_cisco.html#reset-the-cisco-ip-switch-to-factory-defaults[Reset the Cisco IP switch to factory defaults]
+
...
* link:../install-ip/task_switch_config_nvidia.html[Download and install the NVIDIA RCF files]
