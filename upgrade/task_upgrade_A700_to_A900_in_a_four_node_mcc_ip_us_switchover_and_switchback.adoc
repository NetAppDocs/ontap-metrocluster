...
+
NOTE: When you run the boot menu option `6`, the MetroCluster bootarg values might need to be reset. Refer to link:task_upgrade_A700_to_A900_in_a_four_node_mcc_ip_us_switchover_and_switchback.html#set-the-metrocluster-ip-bootarg-variables[Set the MetroCluster IP bootarg variables].
