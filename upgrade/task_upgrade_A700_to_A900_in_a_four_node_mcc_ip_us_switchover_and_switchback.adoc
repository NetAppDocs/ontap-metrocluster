...
CAUTION: When you are repeating this procedure for site_A after replacing the controllers at site_B, the commands in this section might return errors caused by having two different platform models on site_A and site_B.
