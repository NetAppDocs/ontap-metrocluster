...
For the correct RCF file version for your configuration refer to link: https://mysupport.netapp.com/site/tools/tool-eula/rcffilegenerator[RcfFileGenerator Tool] 
