...
== Eight-node FC platform combination matrix

The following matrix shows the supported platform combinations for eight-node MetroCluster FC configurations. 

[IMPORTANT] 
====
* The matrix applies only to regular, or permanent, eight-node configurations. 
* The platform combinations in this matrix *do not* apply if you are using the the transition or refresh procedures. 
