...
== Supported platforms combinations for controller upgrade using switchover and switchback

You can upgrade certain platforms using the switchover and switchback operation.
