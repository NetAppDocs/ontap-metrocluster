...
9.10.1
a|
link:task_upgrade_controllers_system_control_commands_in_a_four_node_mcc_fc.html[Using "system controller replace" commands to upgrade controllers in a four-node MetroClsuter FC configuration (ONTAP 9.10.1 or later)]
