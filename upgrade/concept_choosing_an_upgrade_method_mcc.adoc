...
---
= Start here: Choose between controller upgrade or system refresh
:icons: font
:imagesdir: ../media/

[.lead]
Depending on the scope of the equipment upgrade, you chose either a controller upgrade procedure or a system refresh procedure.
