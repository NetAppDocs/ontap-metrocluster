...
.. If the MetroCluster interfaces are using 169.254.17.x or 18.x IP addresses, refer to <KB_link> to modify the interface IP addresses before you proceed with the upgrade.
+
