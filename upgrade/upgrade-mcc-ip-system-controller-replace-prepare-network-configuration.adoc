...
.. If the MetroCluster interfaces are using 169.254.17.x or 18.x IP addresses, contact NetApp technical support and mention <KB_link> before you proceed with the upgrade.
