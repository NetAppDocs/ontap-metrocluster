...
* You need the UUIDs and system IDs identified earlier in the upgrade procedure in link:upgrade-mcc-ip-system-controller-replace-prechecks.html#gather-information-before-the-upgrade[Gather information before the upgrade].
