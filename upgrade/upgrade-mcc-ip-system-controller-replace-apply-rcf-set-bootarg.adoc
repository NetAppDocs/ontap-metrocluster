...
In this task, you use the UUIDs and system IDs identified earlier in the upgrade procedure in link:upgrade-mcc-ip-system-controller-replace-gather-information.html[Gather information before the upgrade].
