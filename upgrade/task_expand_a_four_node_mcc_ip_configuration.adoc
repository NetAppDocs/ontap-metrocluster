...
== Creating the MetroCluster interfaces, and mirroring root aggregates
...
+
`cluster peer modify -cluster cluster_B -peer-addrs IC interface node_B_1,IC interface node_B_2, IC interface node_B_1-new,IC interface node_B_2-new`
+
From cluster_B, run the following command:
+
`cluster peer modify -cluster cluster_A -peer-addrs IC interface node_A_1,IC interface node_A_2, IC interface node_A_1-new,IC interface node_A_2-new`
