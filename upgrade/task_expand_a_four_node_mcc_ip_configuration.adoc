...
+
NOTE: The command output of the `metrocluster configuration-settings connection show` command can vary depending on your platform model. For example, on some platforms, the lines for HA Partner are not displayed in the output. 
+
----
