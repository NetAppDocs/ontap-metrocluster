...
+
link:../install-ip/concept_considerations_mcip.adoc
+
...
NOTE: You can configure the MetroCluster IP interfaces from either cluster.  Also, starting with ONTAP 9.1.1, if you are using a layer 3 configuration, you must also specify the `-gateway` parameter to create MetroCluster IP interfaces. Refer to link:../install-ip/concept_considerations_layer_3.adoc.
