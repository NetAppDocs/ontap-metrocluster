...
== Eight-node IP platform combination matrix

The following matrix shows the supported platform combinations for eight-node IP configurations. 

[IMPORTANT] 
====
* The matrix applies only to regular, or permanent, 8 node configurations. 
* The platform combinations shown in this matrix *do not* apply if you are using the transition or refresh procedures. 
