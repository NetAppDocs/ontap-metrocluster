...
Review the following information to determine whether your existing and new systems use shared cluster/HA ports or shared MetroCluster/HA ports:
+
include::../_include/shared-metrocluster-ha-or-shared-cluster-ha.adoc[] 

If your existing platform uses shared cluster/HA ports and the platform you're adding uses MetroCluster/HA ports, carefully review <PR link> before you use this procedure.
+
