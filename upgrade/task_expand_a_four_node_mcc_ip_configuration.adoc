...
If your existing platform uses *shared cluster/HA ports* and the platform you're adding uses *shared MetroCluster/HA ports*, carefully review <PR link> before you use this procedure.

You can use the following table to determine whether your existing and new systems use shared cluster/HA ports or shared MetroCluster/HA ports
