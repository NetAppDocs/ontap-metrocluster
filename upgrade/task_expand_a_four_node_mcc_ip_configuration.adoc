...
The following matrix shows the supported platform combinations for 8 node configurations in a MetroCluster IP environment. 
...
image::../media/ip_8node_comb.PNG[Platform combinations for 8 node configurations]

* *Note 1*: Requires ONTAP 9.9.1 or later (or the minimum required release supported by the platform).
* *Note 2*: Requires ONTAP 9.13.1 or later (or the minimum required release supported by the platform).
