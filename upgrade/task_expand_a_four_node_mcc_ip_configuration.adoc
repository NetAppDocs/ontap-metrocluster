...
Beginning with ONTAP 9.13.1 and later, you can temporarily expand an eight-node MetroCluster configuration to refresh the controllers and storage. Refer to link:https://docs.netapp.com/us-en/ontap-metrocluster/upgrade/task_refresh_4n_mcc_ip.html[Refreshing a four-node or an eight-node MetroCluster IP configuration (ONTAP 9.8 and later)] for more information.
