...
. If the system you are upgrading to use shared cluster/HA ports, verify that the MetroCluster IP interfaces are using supported IP addresses. 
+
Use the following information to determine whether the system you are upgrading to use shared cluster/HA ports:
+
