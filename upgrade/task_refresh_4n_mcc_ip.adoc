...
. Move the data from the old nodes to the new nodes by using the following procedures in link:https://docs.netapp.com/us-en/ontap-systems-upgrade/index.html[ONTAP Hardware Systems Documentation^]
