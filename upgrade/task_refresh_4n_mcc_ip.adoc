...
. If you have an AFF A400, FAS8300, or FAS8700 system running ONTAP 9.15.1 or later and you disabled end-to-end encryption earlier in the procedure, you can re-enable it by following the steps to link:../maintain/task-configure-encryption.html[Enable end-to-end encryption].
