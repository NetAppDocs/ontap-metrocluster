...
. If you have an AFF A400, FAS8300, or FAS8700 system running ONTAP 9.15.1 or later with end-to-end encryption enabled, follow the steps in link:../maintain/task-configure-encryption.html[Disable end-to-end encryption]
+
...
. If you have an AFF A400, FAS8300, or FAS8700 system running ONTAP 9.15.1 or later, you can link:../maintain/task-configure-encryption.html[Enable end-to-end encryption].
+
IMPORTANT: End-to-end encryption is only supported on systems that are configured with external key management.
