...
+
If the home port of the intercluster LIFs is used by HA, cluster interconnect, or MetroCluster IP DR ports on the new controllers, you must follow the steps to modify the home port of intercluster LIFs to use a different network port.
