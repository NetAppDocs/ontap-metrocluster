...
This procedure supports FAS8200 to FAS9500 and AFF A300 to AFF A900 controller upgrades.
...
Before the prechecks start, if ONTAP Mediator is installed, it is automatically detected and removed. To confirm the removal, you are prompted to enter a username and password. When you complete the upgrade, or if prechecks fail or you choose not to proceed with the upgrade, you must link:task_upgrade_controllers_system_control_commands_in_a_four_node_mcc_ip.html#reconfigure-ontap-mediator[manually reconfigure ONTAP Mediator].
...
+
The `show` command output displays three tables containing the MetroCluster interface IPs, system IDs, and system UUIDs similar to the following example. This information is required later in the procedure to set the bootargs when you boot the new node. 
+
.Expand the output example
[%collapsible]
====
----
...
----- ------- ------- ---------------  --------------- ------------ ------------
 1    mcc-ip-a300-01-a2a1_siteA mcc-ip-a300-01-a2
              Home Port: e1a
                      172.17.22.11     172.17.22.10   HA Partner  completed
              Home Port: e1a
                      172.17.22.11     172.17.22.12   DR Partner  completed
              Home Port: e1a
                      172.17.22.11     172.17.22.13   DR Auxiliary completed
              Home Port: e1b
                      172.17.23.11     172.17.23.10   HA Partner  completed
              Home Port: e1b
                      172.17.23.11     172.17.23.12   DR Partner  completed
              Home Port: e1b
                      172.17.23.11     172.17.23.13   DR Auxiliary completed

      mcc-ip-a300-01-a1
              Home Port: e1a
                      172.17.22.10     172.17.22.11   HA Partner  completed
              Home Port: e1a
                      172.17.22.10     172.17.22.13   DR Partner  completed
              Home Port: e1a
                      172.17.22.10     172.17.22.12   DR Auxiliary completed
              Home Port: e1b
                      172.17.23.10     172.17.23.11   HA Partner  completed
              Home Port: e1b
                      172.17.23.10     172.17.23.13   DR Partner  completed
              Home Port: e1b
                      172.17.23.10     172.17.23.12   DR Auxiliary completed

      mcc-ip-a300-01-b1b2_siteB mcc-ip-a300-01-b1
              Home Port: e1a
                      172.17.22.12     172.17.22.13   HA Partner  completed
              Home Port: e1a
                      172.17.22.12     172.17.22.11   DR Partner  completed
              Home Port: e1a
                      172.17.22.12     172.17.22.10   DR Auxiliary completed
              Home Port: e1b
                      172.17.23.12     172.17.23.13   HA Partner  completed
              Home Port: e1b
                      172.17.23.12     172.17.23.11   DR Partner  completed
              Home Port: e1b
                      172.17.23.12     172.17.23.10   DR Auxiliary completed

      mcc-ip-a300-01-b2

              Home Port: e1a
                      172.17.22.13     172.17.22.12   HA Partner  completed
              Home Port: e1a
                      172.17.22.13     172.17.22.10   DR Partner  completed
              Home Port: e1a
                      172.17.22.13     172.17.22.11   DR Auxiliary completed
              Home Port: e1b
                      172.17.23.13     172.17.23.12   HA Partner  completed
              Home Port: e1b
                      172.17.23.13     172.17.23.10   DR Partner  completed
              Home Port: e1b
                      172.17.23.13     172.17.23.11   DR Auxiliary completed

 24 entries were displayed.

 dr-group-id cluster                   node              node-systemid ha-partner-systemid dr-partner-systemid   dr-auxiliary-systemid
 ----------- ------------------------- ----------------- ------------- ------------------- ------------------- ---------------------
 1           mcc-ip-a300-01-a2a1_siteA mcc-ip-a300-01-a1 537129626     537129941           537129937           537129628
 1           mcc-ip-a300-01-a2a1_siteA mcc-ip-a300-01-a2 537129941     537129626           537129628           537129937
 1           mcc-ip-a300-01-b1b2_siteB mcc-ip-a300-01-b1 537129628     537129937           537129941           537129626
 1           mcc-ip-a300-01-b1b2_siteB mcc-ip-a300-01-b2 537129937     537129628           537129626           537129941

 4 entries were displayed.

 dr-group-id cluster                   node              node-uuid                            node-cluster-uuid
 ----------- ------------------------- ----------------- ------------------------------------ -----------------------------------
 1           mcc-ip-a300-01-a2a1_siteA mcc-ip-a300-01-a1 c8412ec7-9106-11ed-94d0-00a098d60ff6 c2cfebb7-9107-11ed-9446-00a098d629a8
 1           mcc-ip-a300-01-a2a1_siteA mcc-ip-a300-01-a2 abaa9813-9104-11ed-9446-00a098d629a8 c2cfebb7-9107-11ed-9446-00a098d629a8
 1           mcc-ip-a300-01-b1b2_siteB mcc-ip-a300-01-b1 a2ebebc0-9104-11ed-921f-00a098d61026 c725f8a3-9107-11ed-921f-00a098d61026
 1           mcc-ip-a300-01-b1b2_siteB mcc-ip-a300-01-b2 ca337e85-9106-11ed-9283-00a098d62958 c725f8a3-9107-11ed-921f-00a098d61026
