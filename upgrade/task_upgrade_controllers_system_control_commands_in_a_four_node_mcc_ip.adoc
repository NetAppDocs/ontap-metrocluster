...
----- ------- ------- ---------------  --------------- ------------ ------------
 1    mcc-ip-a300-01-a2a1_siteA mcc-ip-a300-01-a2
              Home Port: e1a
                      <IP address>     <IP address>    HA Partner   completed
              Home Port: e1a
                      <IP address>     <IP address>    DR Partner   completed
              Home Port: e1a
                      <IP address>     <IP address>    DR Auxiliary completed
              Home Port: e1b
                      <IP address>     <IP address>    HA Partner   completed
              Home Port: e1b
                      <IP address>     <IP address>    DR Partner   completed
 ...
 ----------- ------------------------- ----------------- ------------- ------------------- ------------------- ---------------------
 1           mcc-ip-a300-01-a2a1_siteA mcc-ip-a300-01-a1 <system ID>   <system ID>         <system ID>         <system ID>
 1           mcc-ip-a300-01-a2a1_siteA mcc-ip-a300-01-a2 <system ID>   <system ID>         <system ID>         <system ID>
 1           mcc-ip-a300-01-b1b2_siteB mcc-ip-a300-01-b1 <system ID>   <system ID>         <system ID>         <system ID>
 1           mcc-ip-a300-01-b1b2_siteB mcc-ip-a300-01-b2 <system ID>   <system ID>         <system ID>         <system ID>

 4 entries were displayed.

 dr-group-id cluster                   node              node-uuid     node-cluster-uuid
 ----------- ------------------------- ----------------- ----------    -------------------
 1           mcc-ip-a300-01-a2a1_siteA mcc-ip-a300-01-a1 <node UUID>   <node-cluster UUID>
 1           mcc-ip-a300-01-a2a1_siteA mcc-ip-a300-01-a2 <node UUID>   <node-cluster UUID>
 1           mcc-ip-a300-01-b1b2_siteB mcc-ip-a300-01-b1 <node UUID>   <node-cluster UUID>
 1           mcc-ip-a300-01-b1b2_siteB mcc-ip-a300-01-b2 <node UUID>   <node-cluster UUID>
