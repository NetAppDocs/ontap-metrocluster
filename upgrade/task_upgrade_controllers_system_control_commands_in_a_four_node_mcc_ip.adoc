...
* If your system is configured with end-to-end encryption, link:../maintain/task-configure-encryption.html[Disable end-to-end encryption] before performing the upgrade. 
