...
+
Take one of the following actions depending on whether the intercluster LIFs on the old controllers use the same home port as the port used for HA, cluster interconnect, or MetroCluster IP DR on the new controllers.
+
