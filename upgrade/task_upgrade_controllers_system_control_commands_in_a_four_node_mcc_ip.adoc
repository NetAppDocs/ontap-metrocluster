...
+
The `show` command displays three tables containing the MetroCluster interface IPs, system IDs, and system UUIDs similar to the following example. This information is required to set the bootargs later in the procedure when you boot the new node. 
+
