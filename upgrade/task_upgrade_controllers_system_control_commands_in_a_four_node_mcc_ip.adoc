...
To enable networking to resume cleanly on the new controllers, you verify that the LIF placement is correct, and remove the networking configuration of the old controllers.
