...
| Go to...
| Use ports e1a, e7a, e2b, or e3b | <<controller_upgrade_prepare_network_replace_ports_2b,Substep b>>
| Use a different home port | <<controller_upgrade_prepare_network_replace_ports_3,Step 3>>
|===
+
[[controller_upgrade_prepare_network_replace_ports_2b]]
...
+
[[controller_upgrade_prepare_network_replace_ports_3]]
