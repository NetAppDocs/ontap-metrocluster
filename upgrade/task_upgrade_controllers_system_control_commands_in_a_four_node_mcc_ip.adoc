...
---
= Upgrade controllers in a four-node MetroCluster IP configuration using switchover and switchback with "system controller replace" commands (ONTAP 9.11.1 and later)
:icons: font
:imagesdir: ../media/
...
This procedure supports the following controller upgrades.
...
* This procedure applies to controller modules in a four-node MetroCluster IP configuration running ONTAP 9.11.1 or later.
+
