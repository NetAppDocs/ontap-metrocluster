...
* If your system is configured with end-to-end encryption, link:../maintain/task-configure-encryption.html#disable-end-to-end-encryption[Disable end-to-end encryption] before performing the upgrade. 
