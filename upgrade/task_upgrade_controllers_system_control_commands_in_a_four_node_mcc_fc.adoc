...
** For information on what platform upgrade combinations are supported, review the MetroCluster FC upgrade table in  link:concept_choosing_controller_upgrade_mcc.html[Choose a controller upgrade procedure].
