...
+
The `system controller replace start` command performs MetroCluster system health checks that run in the background. In certain circumstances, NetApp recommends that you skip the MetroCluster system health check to avoid unnecessary warnings. 
+
