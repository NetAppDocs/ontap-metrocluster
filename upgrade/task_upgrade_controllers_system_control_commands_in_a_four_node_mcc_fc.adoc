...
+
NOTE: When you run the boot menu option `6`, the MetroCluster bootarg values might need to be reset. Refer to link:upgrade-mcc-ip-manual-apply-rcf-set-bootarg.html#set-the-metrocluster-ip-bootarg-variables[Set the MetroCluster IP bootarg variables].
