...
If you upgraded from a modular system that doesn't have internal drives to an integrated system with disks and controllers in the same chassis, you can add or re-seat the disks that you removed or unseated from the internal slots of the integrated system. After you complete the upgrade on both sites, you can do this at any time. 
