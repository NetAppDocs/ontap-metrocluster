...
If you upgraded from a modular system that doesn't have internal drives to an integrated system with disks and controllers in the same chassis, you can add or re-seat the disks that you removed or unseated from the internal slots of the integrated system at any time after you complete the upgrade on both sites. Refer to link:upgrade-mcc-ip-manual-hba-set-ha.html#remove-internal-drives-integrated-manual[remove internal drives from integrated systems] for more information.
