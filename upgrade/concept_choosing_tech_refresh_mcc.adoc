...
image::../media/metrocluster_techref_fc.png[MetroCluster FC tech refresh combinations]

* Make sure that you complete the tech refresh procedure before adding a new load.
