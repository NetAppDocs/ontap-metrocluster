...
For example, if the platform you want to upgrade is a FAS8200, you can upgrade to a FAS8300. You cannot upgrade a FAS8200 system to an AFF A400 system. 
====
...
* All nodes in the MetroCluster configuration must be running the same ONTAP version. For example, the new controllers must be running the same ONTAP version as the controllers you are upgrading. 
