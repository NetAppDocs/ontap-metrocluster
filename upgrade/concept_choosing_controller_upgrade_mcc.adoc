...
h| Type of upgrade or refresh h| MetroCluster type h| ONTAP version h| Procedure
...
|===
h| Aggregate relocation procedure h|  MetroCluster type h| ONTAP version h| Procedure
