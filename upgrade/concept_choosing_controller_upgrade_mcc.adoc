...
* Note 5: When you upgrade from an AFF A150 or AFF A220 system to an AFF A20 system, there is an option to swap the IOM12 modules with the AFF A150 or AFF A220 controller modules, this converts the system to a shelf that can be attached to the AFF A20 controller.
