...
* Note 5: Requires IOM modules to convert the old controllers to an external shelf. Refer to the link:https://hwu.netapp.com/[NetApp Hardware Universe^] for supported IOM modules.
