...
* Note 4: Upgrades of integrated systems with disks and controllers in the same chassis requires replacement of the controller modules.
...
image:../media/manual-upgrade-combination-group-2-a90-fas90.png[Shows the supported upgrade combinations for the group 2 platforms]
--
====
...
image::../media/metrocluster_fc_upgrade_table_aff_fas.png["Supported platform combinations for MetroCluster FC controller upgrades"]
