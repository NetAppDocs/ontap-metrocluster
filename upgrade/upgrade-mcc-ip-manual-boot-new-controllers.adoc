...
*Note:* You'll need the addresses and port numbers of the primary key servers that you gathered earlier in the procedure. If you configured a username and password for the key servers, you'll also be prompted for this information.
|===
