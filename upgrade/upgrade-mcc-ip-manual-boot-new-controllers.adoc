...
. If you are using a key manager for NetApp Volume Encryption (NVE) or NetApp Storage Encryption (NSE), select the correct boot menu option for your key management configuration. 
+
|===
