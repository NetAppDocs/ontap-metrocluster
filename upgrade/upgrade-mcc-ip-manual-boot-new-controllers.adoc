...
summary: 'Boot up the new controllers and verify that LIFs are hosted on appropriate nodes and ports.'
---
= Boot up the new MetroCluster IP controllers and restore LIF configuration
:icons: font
:imagesdir: ../media/

[.lead]
Boot up the new controllers and verify that LIFs are hosted on appropriate nodes and ports.
