...
*Note:* You'll need the port numbers and addresses of the primary key servers for the admin SVM and the admin SVM UUID that you gathered earlier in the procedure.
|===
