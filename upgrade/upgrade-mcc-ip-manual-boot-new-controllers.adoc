...
If you are using NetApp Volume Encryption (NVE), NetApp Aggregate Encryption (NAE), or NetApp Storage Encryption (NSE) encryption, select the correct boot menu option for your key management configuration. 
