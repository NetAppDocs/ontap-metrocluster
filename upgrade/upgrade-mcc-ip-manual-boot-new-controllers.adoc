...
. If the MetroCluster nodes are configured with a key manager for the admin SVM (cluster), select the correct boot menu option for your key management configuration.  
+
|===
