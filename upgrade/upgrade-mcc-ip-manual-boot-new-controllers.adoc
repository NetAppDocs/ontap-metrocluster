...
*Note:* You'll need the port numbers and addresses of the primary key servers for the admin SVM and the admin SVM UUID that you gathered earlier in the procedure. If you configured a username and password for the key servers, you’ll also be prompted for this information.
|===
