...
[NOTE]
====
* Port usage for the Brocade 6505 and Brocade G610 switches in an eight-node MetroCluster configuration is #shown for the AFF A900 only#. Due to the limited number of ports, port assignments must be made on a site-by-site basis depending on the controller module model and the number of ISLs and bridge pairs in use.
...
NOTE: #The following tables show systems with eight FC-VI ports. AFF A900 has eight FC-VI ports (a, b, c, and d for FC-VI-1 and FC-VI-2).#
...
NOTE: #AFF A900#, AFF A700 or FAS9000 systems support up to eight ISLs for improved performance. Eight ISLs are supported on the Brocade 6510 and G620 switches.
...
NOTE: #The following table shows systems with eight FC-VI ports. AFF A900 has eight FC-VI ports (a, b, c, and d for FC-VI-1 and FC-VI-2).#

|===
6+^h| #Configurations using FibreBridge 7500N or 7600N using both FC ports (FC1 and FC2)#
6+^h| #MetroCluster 2 or DR Group 2#
