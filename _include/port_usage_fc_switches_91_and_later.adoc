...
Review the supported controller configurations in MetroCluster 1 or DR Group 1 using FibreBridge 7500N or 7600N bridges.
...
Review the supported controller configurations in MetroCluster 2 or DR Group 2 using FibreBridge 7500N or 7600N bridges
...
Review the supported shelf configurations in MetroCluster 1 or DR Group 1 using FibreBridge 7500N or 7600N using one FC port (FC1 or FC2) only. You should be aware of the following when using this configuration table:
...
Review the supported shelf configurations in MetroCluster 2 or DR Group 2 for FibreBridge 7500N or 7600N bridges using one FC port (FC1 or FC2) only. You should be aware of the following when using this configuration table:
...
Review the supported shelf configurations in MetroCluster 1 or DR Group 1 for FibreBridge 7500N or 7600N bridges using both FC ports (FC1 or FC2). You should be aware of the following when using this configuration table:
...
Review the supported shelf configurations in MetroCluster 2 or DR Group 2 for FibreBridge 7500N or 7600N bridges using both FC ports (FC1 or FC2). You should be aware of the following when using this configuration table:
