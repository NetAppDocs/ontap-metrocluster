...
[NOTE]
====
* On 6510 and DCX 8510-8 switches in MetroCluster 1 or DR group 1, additional bridges can be cabled to ports 16-19.
*  On 6520 switches in MetroCluster 1 or DR group 1,, additional bridges can be cabled to ports 16-21 and 24-45
* On 6520 switches in MetroCluster 2 or DR group 2, additional bridges can be cabled to ports 64-69 and 72-93.
====
