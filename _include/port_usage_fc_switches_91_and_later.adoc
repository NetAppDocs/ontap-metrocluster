...
[[cisco_9132t_port]]
== Cisco 9132T port usage in MetroCluster 4-node and 8-node configurations running ONTAP 9.4 and later
...
NOTE: For 8-node configurations, you must perform the zoning manually because RCFs are not provided.
