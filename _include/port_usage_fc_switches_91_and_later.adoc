...
|===
4+^h| Cisco 9132T (2x LEM) - 1x four-node MetroCluster or DR Group
4+^h| MetroCluster 1 or DR Group 1
3+^h|
h| Four-node
...
|===
5+^h| Cisco 9132T two four-node MetroCluster or eight-node with two DR groups
5+^h| MetroCluster 1 or DR Group 1
3+^h|
h| Four-node
h| Eight-node
h| FibreBridge 7500N or 7600N using two FC ports h| Port h| Connects to FC_switch... h| 9132T (2x LEM) h| 9132T (2x LEM) 
.2+a|
bridge_x_1a
a|
FC1
...
a|
LEM1-12
5+^h| MetroCluster 2 or DR Group 2
3+^h|
h| Four-node
h| Eight-node
h| FibreBridge 7500N or 7600N using two FC ports h| Port h| Connects to FC_switch... h| 9132T (2x LEM) h| 9132T (2x LEM) 
