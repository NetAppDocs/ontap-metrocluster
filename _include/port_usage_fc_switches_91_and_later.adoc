...
== Cisco 9132T port usage in MetroCluster 4-node and 8-node configurations running ONTAP 9.1 and later
...
2+^h| 4-node
h| 8-node
h| Component h| Port h| Connects to FC_switch... h| 9132T (1x LEM) h| 9132T (2x LEM) h| 9132T (2x LEM) 
.8+a|
controller_x_1
a|
FC-VI port a
...
For 8-node configurations, you must perform the zoning manually because RCF files are not provided.
...
[NOTE]
====
* In 4-node configurations, you can cable additional bridges to ports LEM2-5 through LEM2-8 in 9132T switches with 2x LEMs.
* In 8-node configurations, you can cable additional bridges to ports LEM2-13 through LEM2-16 in 9132T switches with 2x LEMs.
