...
The following table shows controller configurations using FibreBridge 7500N or 7600N using both FC ports (FC1 and FC2). 
...
The following tables show the port usage for Cisco 9132T with 1x LEM and one four-node MetroCluster or DR Group. 
