...
4+^h| Cisco 9148V and Cisco 9124V
...
You can attach additional bridges using ports 37 through 48 following the same pattern.
...
You can attach additional bridges for a second DR group or MetroCluster configuration using ports 37 through 48 following the same pattern.
