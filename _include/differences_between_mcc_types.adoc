...
|===
| Feature | IP configuration Four- or eight-node | IP configurations Two-node| Fabric attached Two-node bridge-attached | Fabric-attached Two-node direct-attached | Stretch configuration
a|
