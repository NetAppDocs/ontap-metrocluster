...
* In a MetroCluster IP configuration, follow the steps in link:../install-ip/task_sw_config_restore_defaults.html[Restore system defaults on a controller module]
