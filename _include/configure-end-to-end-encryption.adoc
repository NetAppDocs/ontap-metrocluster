Beginning with ONTAP 9.15.1, you can configure end-to-end encryption on AFF A400, FAS8300, or FAS8700 systems to encrypt back-end traffic between controllers in MetroCluster IP configurations. 
