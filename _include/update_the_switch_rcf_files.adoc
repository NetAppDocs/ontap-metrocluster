 ...
 ** link:../install-ip/task_switch_config_broadcom.html#reset-the-cisco-ip-switch-to-factory-defaults[Reset the Cisco IP switch to factory defaults]
...
** link:../install-ip/task_switch_config_broadcom.html[Download and install the Cisco IP RCF files]
